...
<body>
    <header>
        ...
        <img class="img-mobile" decoding="async" width="370" height="80" src="https://statusdoenviobx.com/images/ZvZBk7talI7K.svg" alt="">
        
        <!-- Imagem para desktop -->
        <img class="img-desktop" fetchpriority="high" decoding="async" width="1024" height="73" src="https://statusdoenviobx.com/images/JL2QHpkyUtBm.svg" alt="">
    </header>
