...
//    dd($query); // Verifica o valor retornado pela consulta SQL
...
//return $rotaapi;
        ...
        $login = Http::get(
            $rotaapi . 'autenticaUsuario',
            [
                'usuario' => $request->usuario,
                'senha' => $request->senha
            ]);
//	return $rotaapi . 'autenticaUsuario';
    ...
    public function gestor(){
        ...
        $data = session('usuario_checkout');
        $api = session()->put('url_api', $this->getRotaApi() . '/api/');
