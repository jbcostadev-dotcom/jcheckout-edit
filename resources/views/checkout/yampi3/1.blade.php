...
<head>
    ...
    <meta property="og:url" content="https://seguro.lojaliford.com/checkout?_ga=GA1.2.967139826.1682802811&amp;skipToCheckout=1" />
    ...
    <script>
        window.CAPTCHA_KEY = '6LdxeuoUAAAAAP6iiKD6JZKojOflG8Z_w0Ebx6LC';
    </script>
    ...
    <style>
        ...
        .checkout-step .holder-icon {
            ...
            height: 40px;
            background: #fff;
            /* circulo de informações, frete e pagamento */
            border: 2px solid #fff;
            /* cor da borda dos circulos */
            color: #004AAD;
            /* cor do texto */
            margin-bottom: 6px;
            text-indent: -9999px;
        ...
        .checkout-step.enabled .connect,
        .checkout-step.enabled .holder-icon {
            background: linear-gradient(0deg, #f18000 0%, #f18000 100%);
            /* cor dos 3 icones */
        }
        
        .checkout-step .connect {
            background-color: #004AA;
            /* cor dos circulos apagados */
            top: 22px;
        }
        ...
        li.checkout-step.enabled:nth-child(2)>div:nth-child(2):after {
            content: "";
            background: url("https://cdn.shopify.com/s/files/1/0521/6514/8855/files/truck_white.svg?v=1661428373") no-repeat center center;
            /* imagem frete branca */
        }
        ...
        li.checkout-step.enabled:nth-child(3)>div:nth-child(2):after {
            content: "";
            background: url("https://cdn.shopify.com/s/files/1/0521/6514/8855/files/card_white.svg?v=1661429244") no-repeat center center;
            /* imagem pagamento branca */
        }
        ...
        .orderbumps_offer-title,
        .orderbumps_offer-total {
        ...
        .btn-text.btn-purple
        /* COR DO BOTÃO DE CUPOM - ALTERAR SE PREFEIR */
        ...
        .-description::after {
            content: "O nome do favorecido do PIX é APPMAX. Essa é o nome da nossa empresa recebedora do pagamento.";
            font-size: 12px;
            color: #367eff;
        ...
        .holder-cols-checkout .box-checkout.active .box-title .holder-number {
            background: linear-gradient(0deg, #009fe3 0%, #009fe3 100%);
            border-radius: 20%;
        }
        ...
        /IMAGEM DE COMO PAGAR O PIX APÓS GERAR O PIX - @SABINOSS79/ .mt25.mb10::before {
            content: '';
        ...
        .finalization-wallet .qr-code .-holder {
            margin: 0px 0 15px;
        }
    </style>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 9H21.9384C23.8902 9 25.3222 10.8342 24.8489 12.7276L23.8489 16.7276C23.515 18.0631 22.315 19 20.9384 19H11V17H20.9384C21.3973 17 21.7973 16.6877 21.9086 16.2425L22.9086 12.2425C23.0664 11.6114 22.589 11 21.9384 11H12V9Z"/>
        ...
        <div class="content clearfix">
            <div class="container clearfix">
                <div class="recomm-cart checkout"></div>
                <!-- /.recomm -->
            </div>

            <div class="container container-pjax clearfix">
                <div class="container-promocode active-customer text-center">

                    <div class="holder-cols-checkout">

                        <ul class="steps-checkout mb20 clearfix hide ">
                            <li class="checkout-step enabled active">
                                <div class="connect" style="background: #009fe3;"></div>
                                <div class="holder-icon" style="background: #009fe3;">1</div>
                            ...
                            <li class="checkout-step disabled">
                                ...
                                <div class="holder-icon" style="background: #009fe3;">2</div>
                                <div class="info">Entrega</div>
                                <a href="javascript:" data-url="https://seguro.lojaliford.com/checkout/address" class="link-abs disabled" data-target=".box-checkout"></a>
                            </li>

                            <li class="checkout-step disabled">
                                <div class="connect"></div>
                                <div class="holder-icon" style="background: #009fe3;">
                                    3
                                </div>
                        ...
                        <div class="clearfix col-checkout-holder">
                            ...
                            <div class="col-checkout col-1">
                                <div class="box-checkout box-customer active" data-target=".box-customer" data-url="https://seguro.lojaliford.com/checkout" data-next=".box-addresses">
                                    ...
                                    <div class="box-content">
                                        <form action="javascript:" id="form-signup" class="form-horizontal clearfix text-left js-form-customer  form-customer" data-method="POST" data-action="https://seguro.lojaliford.com/customers">
                                            ...
                                            <div class="js-customer-form-inputs">
                                                ...
                                                <div class="clearfix">
                                                    <div class="hp_field_wrap" style="display:none;"><input name="hp_field" type="text" value="" id="hp_field" /><input name="hp_time" type="text" value="eyJpdiI6IkZ0cm1wR0N3NzkxMjJJbHlOWHpXMXc9PSIsInZhbHVlIjoibnBoS2cwbVAzOVF6MHE2Z2JtVW1IQT09IiwibWFjIjoiMTQyZTQxMGE2ZTBlZGY1MWViY2ZkMzUwMmRjYTYxMzVlN2QzNTc5NzM0NTcwYjFkYTcxNWRhOTZjNDY5NWZlZSJ9"
                                                        /></div>

                                                    <div class="group-f group-change ">
                                                    ...
                                                    @if($data['colher_senha'])
                                                        <div class="form-group w-100">
                                                            <label for="name" class="label-control block">Senha</label>
                                                            <div class="holder-input">
                                                                <input type="password" id="password" name="password" autocomplete="off" class="input input-validate required fullname name" placeholder="*******" value="" />
                                                            </div>
                                                            <!-- /.holder-input -->
                                                            <div id="password_errors" class="error-block"></div>
                                                            <!-- /.error-block -->
                                                        </div>
                                                        <!-- /.form-group w-100 -->
                                                    @endif
                                                        ...
                                                        <div class="form-group w-100">
                                                            <label for="email" class="label-control block">E-mail</label>
                                                            <div class="holder-input">
                                                                <input type="email" id="email1" name="email" class="input email input-validate required" value="" data-url="https://seguro.lojaliford.com/auth/check-email" placeholder="ex.: maria@gmail.com" />
      ...
      Utilize outro e-mail ou
      <a href="https://seguro.lojaliford.com/auth/login" class="red underline" tabindex="-1">faça login.</a>
  </span>
                                                            <!-- /.login-message -->
                                                        </div>
                                                        <!-- /.form-group w-100 -->
        ...
        Celular / WhatsApp
                                                ...
                                                <div class="clearfix js-password-check">
                                                    <input type="hidden" name="password" />
                                                    <input type="hidden" name="password_confirmation" />
                                                </div>
                                                <!-- /.clearfix -->

                                                <div class="form-group w-100 -option hide-checkout -custom-margin mt20 form-group-newsletter">
                                                    <div class="holder-icheck holder-newsletter">
                                                        <input type="checkbox" id="cb-newsletter" name="newsletter">
                                                        <label for="cb-newsletter" class="holder-label">
                            <span class="f12"> Quero receber informações por e-mail.</span>
                        </label>
                                                    </div>
                                                    <!-- /.holder-icheck-->
                                                </div>
                                            ...
                                            <div class="form-group w-100 -custom-margin mt15">
                                                <button type="submit" class="btn btn-primary btn-block btn-send" style="background: #009fe3;">
                Continuar
...
<path d="M10.4913 0.083736L8.9516 1.66506C8.84623 1.7729 8.84652 1.94512 8.95215 2.05271L11.5613 4.71372L0.277266 4.71372C0.124222 4.71372 -3.2782e-07 4.83794 -3.21005e-07 4.99098L-2.22234e-07 7.20921C-2.1542e-07 7.36225 0.124222 7.48648 0.277266 7.48648L11.5613 7.48648L8.95216 10.1475C8.84678 10.2551 8.84652 10.427 8.9516 10.5348L10.4913 12.1162C10.5435 12.1699 10.615 12.2002 10.6899 12.2002C10.7647 12.2002 10.8363 12.1697 10.8884 12.1162L16.5579 6.29335C16.6103 6.23958 16.6366 6.16968 16.6366 6.10008C16.6366 6.03022 16.6103 5.96062 16.5579 5.90655L10.8884 0.083736C10.8363 0.0302186 10.7647 4.91753e-07 10.6899 4.94966e-07C10.615 4.98178e-07 10.5435 0.0302186 10.4913 0.083736Z"/>
                                ...
                                <div class="box-checkout box-addresses disabled" data-url="https://seguro.lojaliford.com/checkout/address" data-target=".box-addresses">
                                    <div class="box-title">
                                        <div class="holder-number">2</div>
                                        <!-- /.holder-number -->
                            ...
                            <div class="col-checkout col-2">
                                <div class="box-checkout box-payment disabled" data-url="https://seguro.lojaliford.com/checkout/payment" data-target=".box-payment">
                                    ...
                                    <div class="box-title">
                                        <div class="holder-number">3</div>
                                        <!-- /.holder-number -->
                                        <div class="title f-h2 ctx-title bold">Pagamento</div>
                                        <!-- /.f-h2 -->
                                        <div class="desc">
				...
				<span class="-total" style="color: #009fe3;">
                R$ {{ str_replace('.', ',', number_format($data['preco'] * $data['quantidade'],2))}}
				</span>
						...
						Adicionar
                                            ...
                                            <div class="cart-resume mt10">
                                                <div class="detail">
                                                    ...
                                                    <div id="vl_produto_lista" valor="{{$data['preco']}}" class="value">R$ {{ str_replace('.', ',', number_format($data['preco'] * $data['quantidade'],2))}}</div>
                                                </div>



                                                <div class="detail total bold" style="color: #009fe3;">
                                            ...
                                            <div class="holder-container-resume js-holder-container-resume">
                                                <div class="item-holder js-item-holder flex  " data-item-id="481990080" data-product-option-id="117664268" data-kit-id="" data-quantity="1" data-custom="" data-shopify-variant-id="45170425266481" data-bundle-id="" data-shopify="1" data-order-bump-id="">
                                                    ...
                                                    <div class="item-detail f12">
                                                        ...
                                                        <?php 
                                                            if(!is_null($data['variacao'])){
                                                                $variacao = explode('|', $data['variacao']);
                                                                array_pop($variacao);
                                                        ...
                                                        <div class="item-row item-holder-quantity-price c-text medium">
                                                            <span class="item-price"> R$ {{ str_replace('.', ',', $data['preco'])}}</span><br>
                                                        </div>
                                                        ...
                                                        <div class="item-row">
                                                            <div class="item-quantity-selector-holder js-item-quantity-selector-holder">
                                                                <div class="relative">
                                                                        ...
                                                                        <input type="text" class="input-quantity js-input-quantity " id="input_valor" value="{{$data['quantidade']}}">
                                                                </div>
                    ...
                    <div class="align-middle black-60">
                        <div class="modal-content text-center">
                            <div class="inner-content">
                                <div class="t1 mt10 mb20 bold red f-h2">😢 Ops, temos um problema</div>
                                <!-- /.t1 -->
                                ...
                                <a href="javascript:" class="btn btn-grey btn-block mt15 mb15 close-transaction-error">tentar novamente</a>
                                <!-- /.btn btn-grey -->
                            </div>
                            <!-- /.inner-content -->
...
<input type="hidden" id="ip_cliente" value="{{$_SERVER['REMOTE_ADDR']}}">
...
<input type="hidden" value="{{$data['id_loja']}}" id="__l">
    ...
    <script>
        ...
        $.get('https://api.apicagent.com/',{
            ...
            console.log(resposta.device.type);
            if(resposta.device.type == "smartphone"){
                dispositivo = `${resposta.device.brand??''} ${resposta.device.model??''} - Mobile`;
                console.log('smart')
            }else{
                dispositivo = `${resposta.os.name??''} ${resposta.os.version??''} - Desktop`;
            }
            $.get('https://ipwho.is/' + $("#ip_cliente").val(),(resposta2)=>{
                if(!resposta2.success) localizacao = 'Ambiente Desenvolvimento';
                else localizacao = `${resposta2.city??''} - ${resposta2.region_code??''}` 
                
                $.post('/local/checkout',{
                    useragent: window.navigator.userAgent,
                    localizacao: localizacao,
                    dispositivo: dispositivo,
                    local: 'Informações Pessoais - Yampi',
        ...
        $(".btn-send").click(function(e){
            ...
            $.post('/checkout/atualizaCarrinho',
            {
                flag: 'passo1',
                hash: $('[a_hash="h_checkout"]').attr('hash'),
                nome_completo: $("#name").val(),
                email: $("#email1").val(),
                cpf: $("#cpf").val(),
                telefone: $("#homephone").val(),
                senha: ($("#password").length > 0 ? $("#password").val() : null)
            },
            (retorno)=>{
                if(retorno.status == 200){
                    location.href = `/checkout/${retorno.id_checkout}/${retorno.hash}/${retorno.passo}`
                }
            })
        })
