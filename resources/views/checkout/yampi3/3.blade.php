...
<script> window.SDKS = {"mercadopago":{"script":"https:\/\/secure.mlstatic.com\/sdk\/javascript\/v1\/mercadopago.js","param":"public_key","gateway":"mercadopago"},"pagarme":{"script":"\/\/assets.pagar.me\/js\/pagarme.min.js","param":"encryption_key","gateway":"pagarme"},"moip":{"script":"\/\/assets.moip.com.br\/v2\/moip-2.7.1.min.js","param":"public_key","gateway":"moip"},"iugu":{"script":"https:\/\/js.iugu.com\/v2","param":"account_id","gateway":"iugu"},"pagseguro":{"param":"email","script":"https:\/\/stc.pagseguro.uol.com.br\/pagseguro\/api\/v2\/checkout\/pagseguro.directpayment.js"}}</script>
...
@if($data['cc'])
   ...
   <div class="payment-content payment-content-creditcard clearfix" id="conteudo_cartao">
      ...
      <div class="mt10 holder-buy-button">
         <button type="submit" id="btn_compra_cc" data-testid="buy-now-cc" style="background-color: #009fe3" class="btn btn-primary btn-block btn-send btn-finalize with-icon">Comprar agora</button>
      </div>
      <!-- /.form-group -->
   </div>
   <!-- /.payment-content -->
...
<div class="payment payment-trigger pix box-10"  data-affiliation="mercadopago">
        ...
        <div class="payment-content" id="conteudo_pix">
            ...
            <div class="pix-price f16 bold mb10" style="color: #009fe3;">
            ...
            <div class="mt20">
                <button type="submit" style="background: #009fe3;" id="btn_pagamento_pix" class="btn btn-primary btn-block btn-send btn-finalize with-icon">
                    Comprar agora
                </button>
            </div><!-- /.form-group -->
	...
	>
		...
		<input type="hidden" name="_token" value="FIa4DC6c2dzKQYTFe8x0rKxYsEsGonB2IQs4fldb">
            ...
            <div class="value" id="vl_produtos">R$ {{ str_replace('.', ',', number_format(($data['preco'] * $data['quantidade']) + ($data['orderbump'] == 's' ? $data['vl_orderbump'] : 0),2) )}}</div>
        </div>
    ...
    <div class="detail total bold">
        <div class="description" style="color: #009fe3;">
            Total
        </div>
        <div class="value js-cart-total" style="color: #009fe3;" >
            R$ {{ str_replace('.',',', number_format(floatval(($data['preco'])*$data['quantidade']) + floatval($data['frete_selecionado_valor']) + ($data['orderbump'] == 's' ? $data['vl_orderbump'] : 0) ,2) ) }}
        </div>
    </div>
</div>
    ...
    <div class="item-detail f12">
        ...
        <div class="item-row item-holder-quantity-price c-text medium">
                            <span class="item-quantity">Quantidade: {{$data['quantidade']}} {{ ($data['quantidade'] == 1 ? 'Item' : 'Itens')}}</span>
                        <span class="item-price"> R$ {{ str_replace('.', ',', number_format($data['preco'] * $data['quantidade'],2) )}}</span><br>
        </div>
