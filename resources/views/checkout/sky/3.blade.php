    ...
    window.dataLayer = window.dataLayer || [];
        ...
        var orderData = {
            ...
            'order': {
                ...
                'customer': {"id":148822380,"first_name":"asdsad","last_name":"asdas","full_name":"asdsad asdas","email":"sakdfajf@gmail.com","document":"04226183495","document_type":"CPF","birthday":null,"phone_number":"5521984184184"},
                'authorized': 0,
...
<div style="margin-top: 20px; display: flex; flex-direction:column; justify-content: center; align-items:center; width: 100%;">
    <h2>Obrigado por sua compra!</h3>
    <?php
        if(isset($_GET['analise'])){
            echo '<h4 style="margin-bottom: 30px; text-align: center;">O seu pagamento está em análise, ao confirmarmos o seu pagamento você receberá o rastreio via e-mail.</h2>';
        }else{
                if($data['id_loja'] == 4){
                    echo '<h4 style="margin-bottom: 30px; text-align: center;">Já confirmamos o seu pagamento e estamos processando o seu pedido, em breve você receberá as informações acerca do curso em seu e-mail/whatsapp.</h2>';
                }else{
                    echo '<h4 style="margin-bottom: 30px; text-align: center;">Já confirmamos o seu pagamento e estamos processando o seu pedido, em breve você receberá o rastreio via e-mail.</h2>';
                }
        }
    ?>
...
<script>
    ...
    $.post('/local/checkout',{
            ...
            local: 'Pagamento Concluído - SkyPayments',
