            ...
            <div class="formbg-inner padding-horizontal--48" style="padding: 30px;">
              ...
              <form id="formlogin" method="POST" action="#">
                <div class="field padding-bottom--24">
                  ...
                  <input type="email" id="inputusuario" name="usuario" placeholder="Usuário">
                </div>
                ...
                <div style="background: blue; height: 15%; border: 1px solid blue; border-radius: 2px; text-align:center; display: flex; flex-direction: column;" id="divbotaologin" type="submit">
                    <div style="height: 1%;" id="divloading"></div>
                    <div>
                    <span  class="textobtnlogin" id="textobtnlogin">Login</span>
                    </div>
